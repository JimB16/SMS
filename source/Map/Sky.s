...
__dt__4TSkyFv: # 0x8019fdc8
    ...
    lis     r3, __vvt__4TSky@h
    addi    r3, r3, __vvt__4TSky@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    addi    r3, r30, 0x0
    stw     r0, 0x20(r30)
...
load__4TSkyFR20JSUMemoryInputStream: # 0x8019ff4c
    ...
    lis     r3, unk_8038a210@ha
    addi    r3, r3, unk_8038a210@l
    lwz     r4, 0x14(r4)
    li      r5, 0x3
    lis     r6, 0x1022
    addi    r4, r4, 0x20
...
__sinit_Sky_cpp: # 0x801a033c
    mflr    r0
    lis     r3, unk_803f88d0@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803f88d0@l
