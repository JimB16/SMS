...
load__19TMapEventSinkBiancoFR20JSUMemoryInputStream: # 0x8018f7c4
    ...
    lis     r4, unk_80389060@ha
    lwz     r3, R13Off_m0x5fe0(r13)
    addi    r4, r4, unk_80389060@l
    li      r5, 0x59
...
branch_0x8018f870:
    ...
    lis     r4, unk_80389084@ha
    lwz     r3, R13Off_m0x5fe0(r13)
    addi    r4, r4, unk_80389084@l
    li      r5, 0x1e1
    bl      load__18JPAResourceManagerFPCcUs
    li      r0, 0x1
    stb     r0, 0x0(r31)
...
loadAfter__19TMapEventSinkBiancoFv: # 0x8018f8bc
    mflr    r0
    lis     r4, unk_80388f68@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0xf8(sp)
    stw     r31, 0xf4(sp)
    addi    r31, r4, unk_80388f68@l
    stw     r30, 0xf0(sp)
    stw     r29, 0xec(sp)
    addi    r29, r3, 0x0
    stw     r28, 0xe8(sp)
...
branch_0x8018fc58:
    lwz     r0, 0x28(r31)
    lis     r3, unk_803890c4@ha
    addi    r4, r3, unk_803890c4@l
    lwz     r3, 0x50(r31)
    mulli   r0, r0, 0xc
    lfs     f0, -0x43c0(r2)
    add     r3, r3, r0
...
control__19TMapEventSinkBiancoFv: # 0x8018fcd0
    ...
    add     r5, r4, r0
    lfsx    f1, r4, r0
    lis     r4, unk_803890d4@ha
    lfs     f2, 0x4(r5)
    lfs     f3, 0x8(r5)
    addi    r4, r4, unk_803890d4@l
    li      r5, 0x12c
    li      r6, 0x0
    li      r7, 0x3c
    li      r8, 0x3c
...
finishControl__19TMapEventSinkBiancoFv: # 0x8018fde0
    ...
    stw     r28, 0xb0(sp)
    lwz     r0, 0x28(r3)
    lis     r3, unk_80388f68@ha
    addi    r31, r3, unk_80388f68@l
    cmpwi   r0, 0x0
...
finishControl__13TMapEventSinkFv: # 0x80190b34
    ...
    li      r0, 0x0
    stw     r0, 0x2c(r31)
    lis     r3, unk_80389118@ha
    addi    r3, r3, unk_80389118@l
    stw     r0, 0x30(r31)
    li      r0, -0x1
    stw     r0, 0x28(r31)
    lwz     r4, 0x4(r31)
...
__sinit_MapEventSink_cpp: # 0x80190ffc
    mflr    r0
    lis     r3, unk_803f7e08@h
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803f7e08@l
