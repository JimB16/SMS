...
__dt__26TDolpicEventRiccoMammaGateFv: # 0x801a3484
    ...
    lis     r3, __vvt__26TDolpicEventRiccoMammaGate@h
    addi    r0, r3, __vvt__26TDolpicEventRiccoMammaGate@l
    stw     r0, 0x0(r30)
...
load__26TDolpicEventRiccoMammaGateFR20JSUMemoryInputStream: # 0x801a35a0
    mflr    r0
    lis     r5, unk_8038a448@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x68(sp)
    stw     r31, 0x64(sp)
    addi    r31, r5, unk_8038a448@l
    stw     r30, 0x60(sp)
    addi    r30, r3, 0x0
    stw     r29, 0x5c(sp)
    addi    r29, r4, 0x0
...
watch__26TDolpicEventRiccoMammaGateFv: # 0x801a38f8
    ...
    sth     r0, 0x64(sp)
    addi    r0, sp, 0x64
    lis     r4, unk_8038a5f8@ha
    stw     r0, 0x8(sp)
    addi    r4, r4, unk_8038a5f8@l
    addi    r5, r31, 0x48
    lfs     f1, -0x40a0(r2)
    li      r6, -0x1
    li      r7, 0x0
...
branch_0x801a3a30:
    ...
    sth     r0, 0x60(sp)
    addi    r0, sp, 0x60
    lis     r4, unk_8038a610@ha
    stw     r0, 0x8(sp)
    addi    r4, r4, unk_8038a610@l
    addi    r5, r31, 0x48
    lfs     f1, -0x40a0(r2)
    li      r6, -0x1
    li      r7, 0x0
...
__ct__22TDolpicEventBiancoGateFPCc: # 0x801a3d28
    ...
    mr      r31, r3
    bl      __ct__9TMapEventFPCc
    lis     r3, __vvt__22TDolpicEventBiancoGate@h
    addi    r0, r3, __vvt__22TDolpicEventBiancoGate@l
    stw     r0, 0x0(r31)
    li      r0, 0x0
    addi    r3, r31, 0x0
    stw     r0, 0x20(r31)
...
watch__22TDolpicEventBiancoGateFv: # 0x801a3e00
    mflr    r0
    lis     r4, unk_00010384@h
    stw     r0, 0x4(sp)
    addi    r4, r4, unk_00010384@l
    stwu    sp, -0x18(sp)
    stw     r31, 0x14(sp)
    addi    r31, r3, 0x0
...
__sinit_MapEventDolpic_cpp: # 0x801a3fe8
    mflr    r0
    lis     r3, unk_803f8d98@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803f8d98@l
