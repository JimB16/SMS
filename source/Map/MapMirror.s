...
__ct__19TMirrorModelManagerFPCc: # 0x80192d60
    ...
    stw     r0, 0x0(r31)
    li      r4, 0x0
    lis     r3, __vvt__19TMirrorModelManager@h
    sth     r4, 0xc(r31)
    addi    r3, r3, __vvt__19TMirrorModelManager@l
    li      r0, -0x1
    stw     r3, 0x0(r31)
    mr      r3, r31
    stw     r4, 0x10(r31)
...
branch_0x80192e78:
    ...
    bl      __nwa__FUl
    stw     r3, 0x1c(r31)
    lis     r3, unk_80389254@ha
    lis     r5, __vvt__12TMirrorModel@h
    lis     r4, unk_80389234@ha
    lfs     f31, -0x437c(r2)
    addi    r29, r3, unk_80389254@l
    addi    r27, r5, __vvt__12TMirrorModel@l
    addi    r28, r4, unk_80389234@l
    li      r26, 0x0
    li      r30, 0x0
    b       branch_0x80192f70
...
loadAfter__19TMirrorModelManagerFv: # 0x80192f94
    ...
    lis     r3, unk_80389278@ha
    addi    r30, r3, unk_80389278@l
    lwz     r29, 0x4(r4)
    mr      r3, r30
    bl      calcKeyCode__Q26JDrama8TNameRefFPCc
    lwz     r12, 0x0(r29)
...
__ct__12TMirrorModelFv: # 0x80193890
    lis     r4, __vvt__12TMirrorModel@h
    addi    r0, r4, __vvt__12TMirrorModel@l
    stw     r0, 0x0(r3)
    li      r0, 0x0
    stw     r0, 0x4(r3)
    stw     r0, 0x8(r3)
...
__ct__13TMirrorCameraFPCc: # 0x80193c78
    ...
    stw     r29, 0x74(sp)
    stw     r3, 0x8(sp)
    lis     r3, unk_80389130@ha
    addi    r31, r3, unk_80389130@l
    lwz     r30, 0x8(sp)
    stw     r30, 0x1c(sp)
    stw     r30, 0x20(sp)
    lwz     r3, 0x1c(sp)
    ...
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    lis     r3, __vvt__13TMirrorCamera@h
    stw     r0, 0x20(r30)
    addi    r8, r3, __vvt__13TMirrorCamera@l
    addi    r0, r8, 0x24
    sth     r9, 0x24(r30)
    li      r3, 0x100
    li      r4, 0x100
...
__dt__19TMirrorModelManagerFv: # 0x80194074
    ...
    lis     r3, __vvt__19TMirrorModelManager@h
    addi    r0, r3, __vvt__19TMirrorModelManager@l
    stw     r0, 0x0(r30)
...
__dt__13TMirrorCameraFv: # 0x801940e8
    ...
    lis     r3, __vvt__13TMirrorCamera@h
    addi    r3, r3, __vvt__13TMirrorCamera@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    addi    r3, r30, 0x0
    stw     r0, 0x20(r30)
...
__sinit_MapMirror_cpp: # 0x80194154
    mflr    r0
    lis     r3, unk_803f7f78@h
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803f7f78@l
