...
__ct__16TMapModelManagerFPCc: # 0x80194460
    ...
    lis     r3, __vvt__16TMapModelManager@h
    addi    r0, r3, __vvt__16TMapModelManager@l
    stw     r0, 0x0(r31)
    li      r0, 0x0
    addi    r3, r31, 0x0
    stw     r0, 0x6c(r31)
...
init__16TMapModelManagerFv: # 0x801944a4
    mflr    r0
    lis     r4, unk_80389288@ha
    stw     r0, 0x4(sp)
    li      r0, 0x1
    addi    r4, r4, unk_80389288@l
    stwu    sp, -0x18(sp)
    stw     r31, 0x14(sp)
    addi    r31, r3, 0x0
    stw     r30, 0x10(sp)
    stw     r0, 0x10(r3)
    lis     r3, name_table_2428@h
    addi    r5, r3, name_table_2428@l
    addi    r3, r31, 0x0
...
branch_0x801944f4:
    stw     r30, 0x6c(r31)
    lis     r3, unk_80389298@ha
    addi    r4, r3, unk_80389298@l
    lwz     r3, 0x6c(r31)
    li      r5, 0x2
    li      r6, 0x0
    lwz     r12, 0x0(r3)
...
initUnderpass__9TMapModelFv: # 0x801945c4
    ...
    stw     r30, 0x68(sp)
    lwz     r5, 0x24(r3)
    lis     r3, unk_803892ac@ha
    addi    r4, r3, unk_803892ac@l
    lwz     r3, 0xb0(r5)
...
branch_0x8019463c:
    ...
    addi    r4, r3, j3dDefaultTexMtxInfo@l
    addi    r3, r30, 0x0
...
branch_0x801946c0:
    ...
    blrl
    lhz     r0, 0x0(r3)
    lis     r4, j3dZModeTable@h
    addi    r5, r4, j3dZModeTable@l
    mulli   r0, r0, 0x3
    add     r4, r5, r0
    lbz     r0, 0x0(r4)
    lbz     r4, 0x2(r4)
...
newJointModel__16TMapModelManagerCFi: # 0x80194b3c
    ...
    lis     r3, __vvt__9TMapModel@h
    addi    r0, r3, __vvt__9TMapModel@l
    stw     r0, 0x0(r31)
    li      r0, 0x0
    stw     r0, 0x30(r31)
    stw     r0, 0x34(r31)
...
__sinit_MapModel_cpp: # 0x80194ba4
    mflr    r0
    lis     r3, unk_803f8030@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803f8030@l
