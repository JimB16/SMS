...
__ct__14TRedCoinSwitchFPCc: # 0x801c082c
    ...
    lis     r3, __vvt__14TRedCoinSwitch@ha
    addi    r3, r3, __vvt__14TRedCoinSwitch@l
    stw     r3, 0x0(r31)
    addi    r0, r3, 0x24
    li      r4, 0x0
    stw     r0, 0x20(r31)
...
loadAfter__14TRedCoinSwitchFv: # 0x801c0940
    ...
    lis     r3, unk_803910c0@h
    addi    r31, r3, unk_803910c0@l
    li      r29, 0x0
branch_0x801c0968:
    addi    r5, r31, 0x0
    crxor   6, 6, 6
...
branch_0x801c0a20:
    ...
    stw     r0, 0x104(r31)
    li      r0, 0x3
    lis     r3, unk_00050009@h
    sth     r0, 0xfc(r31)
    addi    r5, r3, unk_00050009@l
    li      r4, 0x1
...
receiveMessage__14TRedCoinSwitchFP9THitActorUl: # 0x801c0a9c
    ...
    lis     r3, unk_803910cc@h
    addi    r4, r3, unk_803910cc@l
    addi    r3, r31, 0x0
...
__ct__13TMapObjSwitchFPCc: # 0x801c0b5c
    ...
    mr      r31, r3
    bl      __ct__11TMapObjBaseFPCc
    lis     r3, __vvt__13TMapObjSwitch@ha
    addi    r3, r3, __vvt__13TMapObjSwitch@l
    stw     r3, 0x0(r31)
    addi    r0, r3, 0x24
    li      r5, 0x0
    stw     r0, 0x20(r31)
...
branch_0x801c0c40:
    ...
    lis     r4, unk_803910dc@h
    lwz     r3, R13Off_m0x5fe0(r13)
    addi    r4, r4, unk_803910dc@l
    li      r5, 0x57
...
receiveMessage__13TMapObjSwitchFP9THitActorUl: # 0x801c0cf8
    ...
    lis     r3, unk_80391100@h
    addi    r4, r3, unk_80391100@l
    addi    r3, r29, 0x0
    bl      startBck__11TMapObjBaseFPCc
    lwz     r3, R13Off_m0x6044(r13)
    li      r4, 0x384c
...
branch_0x801c0d94:
    ...
    sth     r0, 0x2c(sp)
    addi    r0, sp, 0x2c
    lis     r4, unk_8039110c@h
    stw     r0, 0x8(sp)
    addi    r4, r4, unk_8039110c@l
    li      r5, 0x0
    lfs     f1, -0x2b20(r2)
    li      r6, -0x1
    li      r7, 0x1
...
__ct__12THideObjInfoFPCc: # 0x801c0e70
    ...
    stw     r3, 0x0(r31)
    addi    r0, r3, 0x24
    lis     r3, __vvt__12THideObjInfo@ha
    stw     r0, 0x20(r31)
    addi    r4, r3, __vvt__12THideObjInfo@l
    addi    r0, r4, 0x24
    lfs     f0, -0x2b18(r2)
    mr      r3, r31
    stfs    f0, 0x24(r31)
...
__ct__17TMapObjWaterSprayFPCc: # 0x801c109c
    ...
    mr      r31, r3
    bl      __ct__11TMapObjBaseFPCc
    lis     r3, __vvt__17TMapObjWaterSpray@ha
    addi    r3, r3, __vvt__17TMapObjWaterSpray@l
    stw     r3, 0x0(r31)
    addi    r0, r3, 0x24
    li      r3, 0x154
    stw     r0, 0x20(r31)
...
load__10TDamageObjFR20JSUMemoryInputStream: # 0x801c13e4
    ...
    lwz     r0, 0x64(r30)
    lis     r3, unk_8039117c@h
    addi    r3, r3, unk_8039117c@l
    clrrwi  r0, r0, 1
    stw     r0, 0x64(r30)
    mr      r4, r30
...
initMapObj__25TMapObjChangeStageHipDropFv: # 0x801c1648
    ...
    lis     r4, unk_8039118c@h
    lwz     r3, R13Off_m0x5fe0(r13)
    addi    r4, r4, unk_8039118c@l
    li      r5, 0x63
    bl      load__18JPAResourceManagerFPCcUs
    li      r0, 0x1
    stb     r0, 0x0(r31)
...
__ct__8TManholeFPCc: # 0x801c1ae0
    ...
    lis     r3, __vvt__8TManhole@ha
    addi    r3, r3, __vvt__8TManhole@l
    stw     r3, 0x0(r31)
    addi    r0, r3, 0x24
    li      r4, 0x0
    stw     r0, 0x20(r31)
...
branch_0x801c1b80:
    stw     r30, 0x158(r31)
    lis     r3, unk_803911ac@h
    addi    r4, r3, unk_803911ac@l
    lwz     r3, 0x158(r31)
    mr      r6, r31
    li      r5, 0x0
    lwz     r12, 0x0(r3)
...
__ct__5TDoorFPCc: # 0x801c2480
    ...
    mr      r31, r3
    bl      __ct__11TMapObjBaseFPCc
    lis     r3, __vvt__5TDoor@ha
    addi    r3, r3, __vvt__5TDoor@l
    stw     r3, 0x0(r31)
    addi    r3, r3, 0x24
    li      r0, 0x0
    stw     r3, 0x20(r31)
...
__dt__12THideObjInfoFv: # 0x801c2724
    ...
    lis     r3, __vvt__12THideObjInfo@ha
    addi    r3, r3, __vvt__12THideObjInfo@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    addi    r3, r30, 0x0
    stw     r0, 0x20(r30)
...
__sinit_MapObjTown_cpp: # 0x801c2b74
    mflr    r0
    lis     r3, unk_803f9580@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803f9580@l
...
.globl unk_801c2e70
unk_801c2e70: # 0x801c2e70
    addi    r3, r3, -0x20
    b       __dt__5TDoorFv


.globl unk_801c2e78
unk_801c2e78: # 0x801c2e78
    addi    r3, r3, -0x20
    b       __dt__8TManholeFv


.globl unk_801c2e80
unk_801c2e80: # 0x801c2e80
    addi    r3, r3, -0x20
    b       __dt__16TMapObjBillboardFv


.globl unk_801c2e88
unk_801c2e88: # 0x801c2e88
    addi    r3, r3, -0x20
    b       __dt__18TMapObjChangeStageFv


.globl unk_801c2e90
unk_801c2e90: # 0x801c2e90
    addi    r3, r3, -0x20
    b       __dt__25TMapObjChangeStageHipDropFv


.globl unk_801c2e98
unk_801c2e98: # 0x801c2e98
    addi    r3, r3, -0x20
    b       __dt__16TMapObjStartDemoFv


.globl unk_801c2ea0
unk_801c2ea0: # 0x801c2ea0
    addi    r3, r3, -0x20
    b       __dt__10TDamageObjFv


.globl unk_801c2ea8
unk_801c2ea8: # 0x801c2ea8
    addi    r3, r3, -0x20
    b       __dt__17TMapObjWaterSprayFv


.globl unk_801c2eb0
unk_801c2eb0: # 0x801c2eb0
    addi    r3, r3, -0x20
    b       __dt__12THideObjInfoFv


.globl unk_801c2eb8
unk_801c2eb8: # 0x801c2eb8
    addi    r3, r3, -0x20
    b       __dt__13TMapObjSwitchFv


.globl unk_801c2ec0
unk_801c2ec0: # 0x801c2ec0
    addi    r3, r3, -0x20
    b       __dt__14TRedCoinSwitchFv


.globl unk_801c2ec8
unk_801c2ec8: # 0x801c2ec8
    addi    r3, r3, -0x20
