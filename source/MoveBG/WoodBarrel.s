...
__dt__11TWoodBarrelFv: # 0x801aeb40
    ...
    lis     r3, __vvt__11TWoodBarrel@h
    addi    r3, r3, __vvt__11TWoodBarrel@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    stw     r0, 0x20(r30)
...
load__11TWoodBarrelFR20JSUMemoryInputStream: # 0x801aecc0
    ...
    lis     r3, unk_8038aa70@ha
    addi    r4, r3, unk_8038aa70@l
    addi    r3, r30, 0x0
...
__sinit_WoodBarrel_cpp: # 0x801af3a4
    mflr    r0
    lis     r3, unk_803f8fc0@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803f8fc0@l
