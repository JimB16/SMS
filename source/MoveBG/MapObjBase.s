...
branch_0x801afcd8:
    ...
    lis     r3, mDefaultSound__14TMapObjGeneral@h
    slwi    r4, r0, 2
    addi    r0, r3, mDefaultSound__14TMapObjGeneral@l
    add     r3, r0, r4
    lwz     r28, 0x0(r3)
    addis   r0, r28, 0x1
    cmplwi  r0, 0xffff
...
__sinit_MapObjBase_cpp: # 0x801b1460
    mflr    r0
    lis     r3, unk_803f9078@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803f9078@l
