...
__dt__9TJumpBaseFv: # 0x801fd214
    ...
    lis     r3, __vvt__9TJumpBase@h
    addi    r3, r3, __vvt__9TJumpBase@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    stw     r0, 0x20(r30)
...
control__9TJumpBaseFv: # 0x801fd298
    ...
    mr      r29, r3
    lwz     r0, 0xf0(r3)
    lis     r3, unk_80394438@h
    lbz     r30, 0x138(r29)
    addi    r31, r3, unk_80394438@l
...
__ct__12TMushroom1upFiPCc: # 0x801fe294
    ...
    addi    r30, r3, 0x0
    bl      __ct__11TMapObjBaseFPCc
    lis     r3, __vvt__12TMushroom1up@h
    addi    r3, r3, __vvt__12TMushroom1up@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    li      r4, 0x0
    stw     r0, 0x20(r30)
...
__sinit_MapObjItem2_cpp: # 0x801fe384
    mflr    r0
    lis     r3, unk_803faab0@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803faab0@l
...
.globl unk_801fe680
unk_801fe680: # 0x801fe680
    addi    r3, r3, -0x20
    b       __dt__12TMushroom1upFv


.globl unk_801fe688
unk_801fe688: # 0x801fe688
    addi    r3, r3, -0x20
