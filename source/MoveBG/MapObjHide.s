...
__dt__8TWoodBoxFv: # 0x801fe690
    ...
    lis     r3, __vvt__8TWoodBox@h
    addi    r3, r3, __vvt__8TWoodBox@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    stw     r0, 0x20(r30)
...
__ct__8TWoodBoxFPCc: # 0x801fe72c
    ...
    lis     r3, __vvt__13TBreakHideObj@h
    stw     r0, 0x20(r31)
    addi    r6, r3, __vvt__13TBreakHideObj@l
    li      r8, 0x0
    stw     r8, 0x138(r31)
    lis     r3, __vvt__8TWoodBox@h
    addi    r4, r3, __vvt__8TWoodBox@l
    lfs     f0, -0x1e48(r2)
    li      r7, 0x1
    addi    r5, r6, 0x24
    stfs    f0, 0x13c(r31)
...
branch_0x801fe8fc:
    ...
    bl      __nwa__FUl
    stw     r3, 0x144(r31)
    lis     r3, unk_80394658@h
    addi    r5, r3, unk_80394658@l
    crxor   6, 6, 6
    lwz     r6, 0x4(r31)
    lwz     r3, 0x144(r31)
    addi    r4, r30, 0x13
...
branch_0x801fec74:
    ...
    lis     r4, unk_80394670@h
    lwz     r3, R13Off_m0x5fe0(r13)
    addi    r4, r4, unk_80394670@l
    li      r5, 0x6b
...
branch_0x801fecb0:
    ...
    lis     r4, unk_80394694@h
    lwz     r3, R13Off_m0x5fe0(r13)
    addi    r4, r4, unk_80394694@l
    li      r5, 0x6c
    bl      load__18JPAResourceManagerFPCcUs
    li      r0, 0x1
    stb     r0, 0x0(r31)
...
__ct__19THideObjPictureTwinFPCc: # 0x801feea0
    ...
    stw     r0, 0x20(r31)
    addi    r8, r3, __vvt__23TWaterHitPictureHideObj@l
    li      r10, 0x0
    stw     r10, 0x138(r31)
    lis     r3, __vvt__19THideObjPictureTwin@h
    addi    r6, r3, __vvt__19THideObjPictureTwin@l
    lfs     f0, -0x1e48(r2)
    li      r9, 0x1
    addi    r7, r8, 0x24
    stfs    f0, 0x13c(r31)
...
initMapObj__19THideObjPictureTwinFv: # 0x801ff018
    ...
    mr      r31, r3
    bl      initMapObj__11TMapObjBaseFv
    lis     r3, unk_803946b8@h
    lwz     r6, 0x4(r31)
    addi    r5, r3, unk_803946b8@l
    crxor   6, 6, 6
    addi    r3, r31, 0x178
    li      r4, 0x19
    bl      snprintf
...
loadAfter__19THideObjPictureTwinFv: # 0x801ff060
    mflr    r0
    lis     r4, unk_80394560@h
    stw     r0, 0x4(sp)
    stwu    sp, -0x90(sp)
    stmw    r25, 0x74(sp)
    addi    r31, r3, 0x0
    addi    r30, r4, unk_80394560@l
...
__ct__23TWaterHitPictureHideObjFPCc: # 0x801ff2ec
    ...
    lis     r3, __vvt__23TWaterHitPictureHideObj@h
    stw     r0, 0x20(r31)
    addi    r4, r3, __vvt__23TWaterHitPictureHideObj@l
    li      r6, 0x0
    stw     r6, 0x138(r31)
    li      r5, 0x1
    addi    r0, r4, 0x24
...
load__23TWaterHitPictureHideObjFR20JSUMemoryInputStream: # 0x801ff398
    ...
    lis     r4, unk_803946e8@h
    lwz     r3, R13Off_m0x5fe0(r13)
    addi    r4, r4, unk_803946e8@l
    li      r5, 0x57
    bl      load__18JPAResourceManagerFPCcUs
    li      r0, 0x1
    stb     r0, 0x0(r30)
...
branch_0x801ff69c:
    lis     r3, unk_40000020@h
    lwz     r4, 0x4c(r31)
    addi    r0, r3, unk_40000020@l
    cmpw    r4, r0
...
__ct__17TFruitBasketEventFPCc: # 0x801ffed4
    ...
    lis     r3, __vvt__17TFruitBasketEvent@h
    stw     r4, 0x0(r31)
    addi    r0, r4, 0x24
    addi    r4, r3, __vvt__17TFruitBasketEvent@l
    stw     r0, 0x20(r31)
    li      r5, 0x0
    addi    r0, r4, 0x24
    stw     r5, 0x150(r31)
...
__dt__12TFruitBasketFv: # 0x801fff5c
    ...
    lis     r3, __vvt__12TFruitBasket@h
    addi    r3, r3, __vvt__12TFruitBasket@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    stw     r0, 0x20(r30)
...
__dt__19THideObjPictureTwinFv: # 0x80200c48
    ...
    lis     r3, __vvt__19THideObjPictureTwin@h
    addi    r3, r3, __vvt__19THideObjPictureTwin@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    stw     r0, 0x20(r30)
...
__dt__17TFruitBasketEventFv: # 0x80200d8c
    ...
    lis     r3, __vvt__17TFruitBasketEvent@h
    addi    r3, r3, __vvt__17TFruitBasketEvent@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    stw     r0, 0x20(r30)
...
__sinit_MapObjHide_cpp: # 0x80200f60
    mflr    r0
    lis     r3, unk_803fab68@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803fab68@l
...
.globl unk_8020125c
unk_8020125c: # 0x8020125c
    addi    r3, r3, -0x20
    b       __dt__12THideObjBaseFv


.globl unk_80201264
unk_80201264: # 0x80201264
    addi    r3, r3, -0x20
    b       __dt__8THideObjFv


.globl unk_8020126c
unk_8020126c: # 0x8020126c
    addi    r3, r3, -0x20
    b       __dt__16TWaterHitHideObjFv


.globl unk_80201274
unk_80201274: # 0x80201274
    addi    r3, r3, -0x20
    b       __dt__16TFruitHitHideObjFv


.globl unk_8020127c
unk_8020127c: # 0x8020127c
    addi    r3, r3, -0x20
    b       __dt__12TFruitBasketFv


.globl unk_80201284
unk_80201284: # 0x80201284
    addi    r3, r3, -0x20
    b       __dt__17TFruitBasketEventFv


.globl unk_8020128c
unk_8020128c: # 0x8020128c
    addi    r3, r3, -0x20
    b       __dt__15THipDropHideObjFv


.globl unk_80201294
unk_80201294: # 0x80201294
    addi    r3, r3, -0x20
    b       __dt__23TWaterHitPictureHideObjFv


.globl unk_8020129c
unk_8020129c: # 0x8020129c
    addi    r3, r3, -0x20
    b       __dt__19THideObjPictureTwinFv


.globl unk_802012a4
unk_802012a4: # 0x802012a4
    addi    r3, r3, -0x20
    b       __dt__13TBreakHideObjFv


.globl unk_802012ac
unk_802012ac: # 0x802012ac
    addi    r3, r3, -0x20
    b       __dt__8TWoodBoxFv
