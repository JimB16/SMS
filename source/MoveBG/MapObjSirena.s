...
__dt__14TPictureTelesaFv: # 0x801c8194
    ...
    lis     r3, __vvt__23TWaterHitPictureHideObj@h
    addi    r3, r3, __vvt__23TWaterHitPictureHideObj@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    stw     r0, 0x20(r30)
    beq-    branch_0x801c8204
...
__ct__14TWarpAreaActorFPCc: # 0x801c8704
    ...
    lis     r3, __vvt__14TWarpAreaActor@ha
    addi    r3, r3, __vvt__14TWarpAreaActor@l
    stw     r3, 0x0(r31)
    addi    r3, r3, 0x24
    li      r0, -0x1
    stw     r3, 0x20(r31)
...
load__14TWarpAreaActorFR20JSUMemoryInputStream: # 0x801c8754
    ...
    bl      read__14JSUInputStreamFPvl
    lwz     r0, 0x10(sp)
    lis     r4, unk_4000019d@h
    addi    r3, r30, 0x0
    extsh   r0, r0
    sth     r0, 0x6a(r30)
    addi    r4, r4, unk_4000019d@l
    li      r5, 0x1
    lfs     f3, -0x29b0(r2)
    lis     r6, 0x8000
    lfs     f2, -0x29a0(r2)
...
branch_0x801c899c:
    ...
    lis     r4, unk_80391694@h
    lwz     r3, 0x74(r28)
    addi    r4, r4, unk_80391694@l
...
branch_0x801c8d8c:
    stw     r30, 0x138(r31)
    lis     r3, unk_803916a4@h
    addi    r4, r3, unk_803916a4@l
    lwz     r3, 0x138(r31)
    mr      r6, r31
    li      r5, 0x0
    lwz     r12, 0x0(r3)
...
__ct__11TSakuCasinoFPCc: # 0x801c8df0
    ...
    lis     r3, __vvt__11TSakuCasino@ha
    addi    r3, r3, __vvt__11TSakuCasino@l
    stw     r3, 0x0(r31)
    addi    r3, r3, 0x24
    li      r0, 0x0
    stw     r3, 0x20(r31)
...
calcRootMatrix__7TClosetFv: # 0x801c8fac
    ...
    lis     r4, unk_803916b8@h
    lwz     r3, 0x74(r29)
    addi    r4, r4, unk_803916b8@l
    li      r5, 0x0
...
branch_0x801c9510:
    ...
    mr      r3, r31
    bl      initMapObj__11TMapObjBaseFv
    lis     r3, partsRollCallback__FP7J3DNodei@ha
    addi    r30, r3, partsRollCallback__FP7J3DNodei@l
    li      r29, 0x1
    b       branch_0x801c9548
...
branch_0x801c95ec:
    stw     r29, 0x168(r31)
    lis     r3, unk_803916e4@h
    addi    r4, r3, unk_803916e4@l
    lwz     r3, 0x168(r31)
    mr      r6, r31
    li      r5, 0x0
    lwz     r12, 0x0(r3)
...
__ct__7TClosetFPCc: # 0x801c965c
    ...
    stw     r3, 0x0(r31)
    addi    r0, r3, 0x24
    lis     r3, __vvt__7TCloset@ha
    stw     r0, 0x20(r31)
    addi    r4, r3, __vvt__7TCloset@l
    li      r6, 0x0
    stw     r6, 0x138(r31)
    li      r5, 0x1
    addi    r0, r4, 0x24
...
branch_0x801c98e0:
    ...
    sth     r0, 0x58(sp)
    addi    r0, sp, 0x58
    lis     r4, unk_803916f4@h
    stw     r0, 0x8(sp)
    addi    r4, r4, unk_803916f4@l
    addi    r5, r31, 0x10
    lfs     f1, -0x29b0(r2)
    li      r6, -0x1
    li      r7, 0x1
...
branch_0x801c9b24:
    stw     r30, 0x138(r31)
    lis     r3, unk_80391720@h
    addi    r4, r3, unk_80391720@l
    lwz     r3, 0x138(r31)
    mr      r6, r31
    li      r5, 0x0
    lwz     r12, 0x0(r3)
...
__ct__8TDonchouFPCc: # 0x801c9b88
    ...
    mr      r31, r3
    bl      __ct__11TMapObjBaseFPCc
    lis     r3, __vvt__8TDonchou@ha
    addi    r3, r3, __vvt__8TDonchou@l
    stw     r3, 0x0(r31)
    addi    r3, r3, 0x24
    li      r0, 0x0
    stw     r3, 0x20(r31)
...
branch_0x801ca2b8:
    ...
    li      r0, 0x1
    stb     r0, 0x16d(r29)
    addi    r4, r2, R2Off_m0x2990
    lwz     r3, 0x74(r29)
    bl      setBck__6MActorFPCc
    lis     r3, unk_80010025@h
    addi    r3, r3, unk_80010025@l
...
branch_0x801ca3e8:
    ...
    bl      initMapObj__11TMapObjBaseFv
    lis     r3, partsRollCallback__FP7J3DNodei@ha
    addi    r31, r3, partsRollCallback__FP7J3DNodei@l
    li      r30, 0x1
    b       branch_0x801ca41c
...
__ct__16TCasinoPanelGateFPCc: # 0x801ca448
    ...
    stw     r3, 0x0(r31)
    addi    r0, r3, 0x24
    lis     r3, __vvt__16TCasinoPanelGate@ha
    stw     r0, 0x20(r31)
    addi    r4, r3, __vvt__16TCasinoPanelGate@l
    li      r6, 0x0
    stw     r6, 0x138(r31)
    li      r5, 0x1
    addi    r0, r4, 0x24
...
branch_0x801ca790:
    ...
    lis     r4, unk_80391730@h
    lwz     r3, R13Off_m0x70b0(r13)
    addi    r5, r4, unk_80391730@l
    addi    r4, r29, 0x10
    li      r6, 0x1
...
__ct__13TItemSlotDrumFPCc: # 0x801cb458
    ...
    stw     r3, 0x0(r31)
    addi    r0, r3, 0x24
    lis     r3, __vvt__13TItemSlotDrum@ha
    stw     r0, 0x20(r31)
    li      r5, 0x0
    addi    r3, r3, __vvt__13TItemSlotDrum@l
    stb     r5, 0x194(r31)
    addi    r4, r3, 0x24
    li      r0, 0x1
    stw     r3, 0x0(r31)
...
initNeonMatColor__9TSlotDrumFv: # 0x801cbc28
    mflr    r0
    lis     r4, unk_80391688@h
    stw     r0, 0x4(sp)
    addi    r5, r4, unk_80391688@l
    stwu    sp, -0x58(sp)
    stmw    r25, 0x3c(sp)
    mr      r30, r3
    addi    r27, sp, 0x28
...
__ct__9TSlotDrumFPCc: # 0x801cbe78
    ...
    lis     r3, __vvt__9TSlotDrum@ha
    stw     r0, 0x20(r31)
    addi    r4, r3, __vvt__9TSlotDrum@l
    li      r6, 0x0
    stw     r6, 0x138(r31)
    li      r5, 0x1
    addi    r0, r4, 0x24
...
branch_0x801cc4c8:
    ...
    addi    r4, r31, 0x1b4
    bl      __ct__9THitActorFPCc
    lis     r3, __vvt__11TRouletteSw@ha
    addi    r3, r3, __vvt__11TRouletteSw@l
    stw     r3, 0x0(r29)
    addi    r3, r3, 0x24
    li      r0, 0x0
    stw     r3, 0x20(r29)
...
__dt__16TCasinoPanelGateFv: # 0x801ccb78
    ...
    lis     r3, __vvt__16TCasinoPanelGate@ha
    addi    r3, r3, __vvt__16TCasinoPanelGate@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    stw     r0, 0x20(r30)
...
__sinit_MapObjSirena_cpp: # 0x801ccdc8
    mflr    r0
    lis     r3, unk_803f97a8@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803f97a8@l
...
.globl unk_801cd0c4
unk_801cd0c4: # 0x801cd0c4
    addi    r3, r3, -0x20
    b       __dt__11TRouletteSwFv


.globl unk_801cd0cc
unk_801cd0cc: # 0x801cd0cc
    addi    r3, r3, -0x20
    b       __dt__9TRouletteFv


.globl unk_801cd0d4
unk_801cd0d4: # 0x801cd0d4
    addi    r3, r3, -0x20
    b       __dt__9TSlotDrumFv


.globl unk_801cd0dc
unk_801cd0dc: # 0x801cd0dc
    addi    r3, r3, -0x20
    b       __dt__13TItemSlotDrumFv


.globl unk_801cd0e4
unk_801cd0e4: # 0x801cd0e4
    addi    r3, r3, -0x20
    b       __dt__16TCasinoPanelGateFv


.globl unk_801cd0ec
unk_801cd0ec: # 0x801cd0ec
    addi    r3, r3, -0x20
    b       __dt__8TDonchouFv


.globl unk_801cd0f4
unk_801cd0f4: # 0x801cd0f4
    addi    r3, r3, -0x20
    b       __dt__7TClosetFv


.globl unk_801cd0fc
unk_801cd0fc: # 0x801cd0fc
    addi    r3, r3, -0x20
    b       __dt__11TSakuCasinoFv


.globl unk_801cd104
unk_801cd104: # 0x801cd104
    addi    r3, r3, -0x20
    b       __dt__15TSirenabossWallFv


.globl unk_801cd10c
unk_801cd10c: # 0x801cd10c
    addi    r3, r3, -0x20
    b       __dt__17TSirenaCasinoRoofFv


.globl unk_801cd114
unk_801cd114: # 0x801cd114
    addi    r3, r3, -0x20
    b       __dt__14TWarpAreaActorFv


.globl unk_801cd11c
unk_801cd11c: # 0x801cd11c
    addi    r3, r3, -0x20
    b       __dt__13TChestRevolveFv


.globl unk_801cd124
unk_801cd124: # 0x801cd124
    addi    r3, r3, -0x20
    b       __dt__13TPanelRevolveFv


.globl unk_801cd12c
unk_801cd12c: # 0x801cd12c
    addi    r3, r3, -0x20
