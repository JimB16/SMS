...
initKeyCode__14TMapObjManagerFv: # 0x801b176c
    mflr    r0
    lis     r3, sObjDataTable@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x20(sp)
    stw     r31, 0x1c(sp)
    li      r31, 0x0
    stw     r30, 0x18(sp)
    addi    r30, r3, sObjDataTable@l
    stw     r29, 0x14(sp)
    b       branch_0x801b17ac
...
branch_0x801b19c4:
    ...
    lis     r3, unk_80390424@h
    addi    r30, r3, unk_80390424@l
    lwz     r29, 0x4(r4)
    mr      r3, r30
    bl      calcKeyCode__Q26JDrama8TNameRefFPCc
    lwz     r12, 0x0(r29)
...
initActorData__11TMapObjBaseFv: # 0x801b1ad0
    ...
    lwz     r3, 0xf4(r3)
    bl      calcKeyCode__Q26JDrama8TNameRefFPCc
    lis     r4, sObjDataTable@ha
    clrlwi  r27, r3, 16
    addi    r29, r4, sObjDataTable@l
    b       branch_0x801b1b24
...
branch_0x801b1b38:
    lis     r4, unk_8039043c@h
    lwz     r3, 0x4(r31)
    addi    r4, r4, unk_8039043c@l
    bl      strcmp
    cmpwi   r3, 0x0
...
initUnique__11TMapObjBaseFv: # 0x801b244c
    ...
    stw     r28, 0x2c8(sp)
    lwz     r0, 0x4c(r3)
    addi    r3, r5, unk_4000009c@l
    cmpw    r0, r3
    beq-    branch_0x801b28f8
    bge-    branch_0x801b2568
    lis     r4, unk_20000068@h
    addi    r3, r4, unk_20000068@l
    cmpw    r0, r3
...
__sinit_MapObjInit_cpp: # 0x801b2c90
    mflr    r0
    lis     r3, unk_803f9130@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803f9130@l
