...
__dt__18TSuperHipDropBlockFv: # 0x801c2ed0
    ...
    addi    r3, r3, __vvt__18TSuperHipDropBlock@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    stw     r0, 0x20(r30)
...
loadAfter__18TSuperHipDropBlockFv: # 0x801c2f6c
    ...
    lis     r3, unk_803912c8@h
    lwz     r4, 0x4(r31)
    addi    r3, r3, unk_803912c8@l
    bl      strcmp
    cmpwi   r3, 0x0
    bne-    branch_0x801c2fdc
    li      r0, 0x1
    stb     r0, 0x150(r31)
    lis     r3, unk_0001038c@h
    addi    r4, r3, unk_0001038c@l
...
receiveMessage__18TSuperHipDropBlockFP9THitActorUl: # 0x801c2ff0
    ...
    lis     r4, unk_0001038c@h
    lwz     r3, R13Off_m0x6060(r13)
    addi    r5, r4, unk_0001038c@l
    li      r4, 0x1
...
initMapObj__11TBrickBlockFv: # 0x801c33ec
    mflr    r0
    lis     r4, unk_803911d0@h
    stw     r0, 0x4(sp)
    stwu    sp, -0x18(sp)
    stw     r31, 0x14(sp)
    addi    r31, r4, unk_803911d0@l
    stw     r30, 0x10(sp)
    bl      initMapObj__11TMapObjBaseFv
...
initMapObj__9TIceBlockFv: # 0x801c3660
    ...
    lis     r4, unk_80391340@h
    lwz     r3, R13Off_m0x5fe0(r13)
    addi    r4, r4, unk_80391340@l
    li      r5, 0x157
    bl      load__18JPAResourceManagerFPCcUs
    li      r0, 0x1
    stb     r0, 0x0(r31)
branch_0x801c36a8:
    ...
    lis     r4, unk_8039135c@h
    lwz     r3, R13Off_m0x5fe0(r13)
    addi    r4, r4, unk_8039135c@l
    li      r5, 0x158
    bl      load__18JPAResourceManagerFPCcUs
    li      r0, 0x1
    stb     r0, 0x0(r31)
...
initMapObj__10TSandBlockFv: # 0x801c3f84
    ...
    lis     r4, unk_80391378@h
    lwz     r3, R13Off_m0x5fe0(r13)
    addi    r4, r4, unk_80391378@l
    li      r5, 0x147
    bl      load__18JPAResourceManagerFPCcUs
    li      r0, 0x1
    stb     r0, 0x0(r31)
branch_0x801c3fec:
    ...
    lis     r4, unk_8039139c@h
    lwz     r3, R13Off_m0x5fe0(r13)
    addi    r4, r4, unk_8039139c@l
    li      r5, 0x148
    bl      load__18JPAResourceManagerFPCcUs
    li      r0, 0x1
    stb     r0, 0x0(r31)
...
__sinit_MapObjBlock_cpp: # 0x801c461c
    mflr    r0
    lis     r3, unk_803f9638@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803f9638@l
...
.globl unk_801c4918
unk_801c4918: # 0x801c4918
    addi    r3, r3, -0x20
    b       __dt__15TBreakableBlockFv


.globl unk_801c4920
unk_801c4920: # 0x801c4920
    addi    r3, r3, -0x20
    b       __dt__10TSandBlockFv


.globl unk_801c4928
unk_801c4928: # 0x801c4928
    addi    r3, r3, -0x20
    b       __dt__10TLeanBlockFv


.globl unk_801c4930
unk_801c4930: # 0x801c4930
    addi    r3, r3, -0x20
    b       __dt__9TIceBlockFv


.globl unk_801c4938
unk_801c4938: # 0x801c4938
    addi    r3, r3, -0x20
    b       __dt__11TBrickBlockFv


.globl unk_801c4940
unk_801c4940: # 0x801c4940
    addi    r3, r3, -0x20
    b       __dt__11TJuiceBlockFv


.globl unk_801c4948
unk_801c4948: # 0x801c4948
    addi    r3, r3, -0x20
    b       __dt__12TTelesaBlockFv


.globl unk_801c4950
unk_801c4950: # 0x801c4950
    addi    r3, r3, -0x20
