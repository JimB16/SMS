...
__dt__10TSandPlaneFv: # 0x801de3e0
    ...
    lis     r3, __vvt__12TMapObjPlane@h
    addi    r3, r3, __vvt__12TMapObjPlane@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    addi    r3, r30, 0x0
    stw     r0, 0x20(r30)
...
load__10TSandPlaneFR20JSUMemoryInputStream: # 0x801de46c
    ...
    stw     r30, 0x10(sp)
    addi    r30, r3, 0x0
    lis     r3, unk_80392930@h
    lfs     f0, -0x2484(r2)
    addi    r3, r3, unk_80392930@l
    stfs    f0, 0xfc(r30)
    stw     r0, 0x100(r30)
    ...
    lis     r3, unk_80392950@h
    addi    r3, r3, unk_80392950@l
    bl      getGlbResource__13JKRFileLoaderFPCc
    stw     r3, 0x118(r30)
    addi    r3, r30, 0x0
    addi    r4, r31, 0x0
...
load__10TRockPlaneFR20JSUMemoryInputStream: # 0x801de4e8
    ...
    stw     r30, 0x10(sp)
    addi    r30, r3, 0x0
    lis     r3, unk_80392970@h
    lfs     f0, -0x2484(r2)
    addi    r3, r3, unk_80392970@l
    stfs    f0, 0xfc(r30)
    stw     r0, 0x100(r30)
    bl      getGlbResource__13JKRFileLoaderFPCc
    stw     r3, 0x114(r30)
    ...
    lis     r3, unk_80392990@h
    addi    r3, r3, unk_80392990@l
    bl      getGlbResource__13JKRFileLoaderFPCc
    stw     r3, 0x118(r30)
    addi    r3, r30, 0x0
    addi    r4, r31, 0x0
...
initDraw__12TMapObjPlaneFv: # 0x801df468
    ...
    li      r9, 0x2
    bl      GXSetChanCtrl
    lwz     r0, R2Off_m0x2490(r2)
    addi    r4, sp, 0x2c
    lbz     r5, R13Off_m0x78bc(r13)
    li      r3, 0x4
    stw     r0, 0x28(sp)
    stb     r5, 0x28(sp)
    stb     r5, 0x29(sp)
...
__sinit_MapObjPlane_cpp: # 0x801df7f0
    mflr    r0
    lis     r3, unk_803f9e40@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803f9e40@l
...
.globl unk_801dfaec
unk_801dfaec: # 0x801dfaec
    addi    r3, r3, -0x20
    b       __dt__12TMapObjPlaneFv


.globl unk_801dfaf4
unk_801dfaf4: # 0x801dfaf4
    addi    r3, r3, -0x20
    b       __dt__10TRockPlaneFv


.globl unk_801dfafc
unk_801dfafc: # 0x801dfafc
    addi    r3, r3, -0x20
