...
__dt__19TMapObjGrassManagerFv: # 0x801e8f84
    ...
    lis     r3, __vvt__19TMapObjGrassManager@h
    addi    r0, r3, __vvt__19TMapObjGrassManager@l
    stw     r0, 0x0(r30)
...
__ct__19TMapObjGrassManagerFPCc: # 0x801e8ff8
    ...
    lis     r5, mDrawVec__19TMapObjGrassManager@ha
    stwu    sp, -0x20(sp)
    stw     r31, 0x1c(sp)
    addi    r31, r5, mDrawVec__19TMapObjGrassManager@l
    stw     r30, 0x18(sp)
    addi    r30, r3, 0x0
    stw     r0, 0x0(r3)
    stw     r4, 0x4(r3)
    ...
    stw     r7, 0x20(r30)
    stw     r7, 0x24(r30)
    stw     r30, R13Off_m0x6244(r13)
    stfs    f0, 0x8(r31)
    stfs    f0, 0x4(r31)
    stfs    f0, 0x0(r31)
    stb     r6, R13Off_m0x6250(r13)
    stb     r5, 0x1(r4)
    stb     r6, 0x2(r4)
    stb     r0, 0x3(r4)
    lwz     r0, 0x24(sp)
...
initDrawNear__19TMapObjGrassManagerCFv: # 0x801e9344
    ...
    lis     r3, j3dSys@h
    stw     r0, 0x4(sp)
    lis     r4, mDrawVec__19TMapObjGrassManager@ha
    addi    r3, r3, j3dSys@l
    stwu    sp, -0x98(sp)
    stw     r31, 0x94(sp)
    addi    r31, r4, mDrawVec__19TMapObjGrassManager@l
    addi    r4, sp, 0x44
    bl      PSMTXInverse
    lfs     f1, 0x44(sp)
    addi    r8, r13, R13Off_m0x624c
    lfs     f0, -0x7880(r13)
    li      r3, 0x0
    lfs     f2, 0x54(sp)
    fmuls   f1, f1, f0
...
__ct__17TMapObjGrassGroupFv: # 0x801e9590
    mflr    r0
    lis     r4, unk_80392ff8@h
    stw     r0, 0x4(sp)
    addi    r4, r4, unk_80392ff8@l
    stwu    sp, -0x18(sp)
    stw     r31, 0x14(sp)
    addi    r31, r3, 0x0
    bl      __ct__9THitActorFPCc
    lis     r3, __vvt__17TMapObjGrassGroup@h
    addi    r3, r3, __vvt__17TMapObjGrassGroup@l
    stw     r3, 0x0(r31)
    addi    r3, r3, 0x24
    li      r0, 0x0
    stw     r3, 0x20(r31)
...
load__17TMapObjGrassGroupFR20JSUMemoryInputStream: # 0x801e95f4
    ...
    addi    r4, r4, __ct__Q29JGeometry8TVec3_s_Fv@l
    addi    r7, r25, 0x0
    li      r5, 0x0
    li      r6, 0x6
    bl      __construct_new_array
...
branch_0x801e98ac:
    ...
    mulli   r5, r0, 0x3
    bl      GXBegin
    lwz     r11, R13Off_m0x6244(r13)
    li      r28, 0x0
    addi    r27, r13, R13Off_m0x624c
    li      r26, 0x0
    li      r3, 0x0
    li      r4, 0x0
    lis     r9, 0xcc01
...
branch_0x801e99d8:
    ...
    mulli   r5, r0, 0x3
    bl      GXBegin
    lis     r3, mDrawVec__19TMapObjGrassManager@ha
    lwz     r8, R13Off_m0x6244(r13)
    addi    r10, r3, mDrawVec__19TMapObjGrassManager@l
    li      r12, 0x0
    li      r30, 0x0
    li      r3, 0x0
    lis     r6, 0xcc01
...
__sinit_MapObjGrass_cpp: # 0x801e9b50
    ...
    stw     r3, R13Off_m0x6258(r13)
    extsb.  r0, r0
    stw     r3, R13Off_m0x6254(r13)
    stw     r3, R13Off_m0x6250(r13)
