...
__dt__18TMapObjFlagManagerFv: # 0x801db248
    ...
    lis     r3, __vvt__18TMapObjFlagManager@h
    addi    r0, r3, __vvt__18TMapObjFlagManager@l
    stw     r0, 0x0(r30)
...
__ct__18TMapObjFlagManagerFPCc: # 0x801db2bc
    ...
    sth     r0, 0xc(r31)
    addi    r0, r3, __vvt__18TMapObjFlagManager@l
    lis     r3, __ct__Q218TMapObjFlagManager15TMapObjFlagInfoFv@ha
    stw     r0, 0x0(r31)
    addi    r4, r3, __ct__Q218TMapObjFlagManager15TMapObjFlagInfoFv@l
    addi    r3, r31, 0x10
    li      r5, 0x0
    li      r6, 0x58
    li      r7, 0xf
    bl      __construct_array
    stw     r31, R13Off_m0x6280(r13)
    mr      r3, r31
    lwz     r0, 0x1c(sp)
    lwz     r31, 0x14(sp)
    addi    sp, sp, 0x18
...
registerObj__18TMapObjFlagManagerFP11TMapObjFlagPCc: # 0x801db3ec
    mflr    r0
    lis     r6, unk_80392460@h
    stw     r0, 0x4(sp)
    stwu    sp, -0x3e8(sp)
    stw     r31, 0x3e4(sp)
    addi    r31, r6, unk_80392460@l
    stw     r30, 0x3e0(sp)
    addi    r30, r5, 0x0
    stw     r29, 0x3dc(sp)
    addi    r29, r4, 0x0
    addi    r4, r2, R2Off_m0x2578
    stw     r28, 0x3d8(sp)
    addi    r28, r3, 0x0
    addi    r3, r30, 0x0
    bl      strcmp
...
__ct__11TMapObjFlagFPCc: # 0x801dbdec
    ...
    lis     r3, __vvt__11TMapObjFlag@h
    lwz     r31, 0x8(sp)
    addi    r3, r3, __vvt__11TMapObjFlag@l
    stw     r3, 0x0(r31)
    addi    r3, r3, 0x24
    li      r0, 0x0
    stw     r3, 0x20(r31)
...
branch_0x801dc17c:
    ...
    lbz     r0, R13Off_m0x6278(r13)
    extsb.  r0, r0
    bne-    branch_0x801dc1a4
    li      r3, 0x0
    li      r0, 0x1
    stw     r3, R13Off_m0x627c(r13)
    stb     r0, R13Off_m0x6278(r13)
branch_0x801dc1a4:
    lwz     r3, R13Off_m0x5f2c(r13)
    lwz     r12, 0x0(r3)
    lwz     r12, 0x28(r12)
    mtlr    r12
    blrl
    lwz     r3, R13Off_m0x6280(r13)
    addi    r4, r28, 0x0
    addi    r5, r29, 0x0
    bl      registerObj__18TMapObjFlagManagerFP11TMapObjFlagPCc
    lfs     f1, -0x2564(r2)
    lis     r4, unk_4000000d@h
    addi    r3, r28, 0x0
    fmr     f2, f1
    addi    r4, r4, unk_4000000d@l
    fmr     f3, f1
    li      r5, 0x1
    fmr     f4, f1
    li      r6, 0x0
...
__sinit_MapObjFlag_cpp: # 0x801dc688
    mflr    r0
    lis     r3, unk_803f9c18@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803f9c18@l
