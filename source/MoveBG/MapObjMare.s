...
calcRootMatrix__9TMareCorkFv: # 0x801d79f4
    ...
    lis     r4, unk_80392330@h
    lwz     r3, R13Off_m0x62b0(r13)
    lis     r5, unk_80392344@h
    lfs     f1, 0x10(r31)
    lfs     f2, 0x14(r31)
    addi    r4, r4, unk_80392330@l
    lfs     f3, 0x18(r31)
    addi    r5, r5, unk_80392344@l
...
moveObject__9TMareCorkFv: # 0x801d7aec
    ...
    lis     r4, unk_80392358@h
    lwz     r3, 0x74(r31)
    addi    r4, r4, unk_80392358@l
    bl      setBck__6MActorFPCc
    lis     r3, unk_80392364@h
    addi    r4, r3, unk_80392364@l
    addi    r3, r31, 0x0
...
loadAfter__9TMareCorkFv: # 0x801d7b60
    mflr    r0
    lis     r5, unk_80392238@h
    stw     r0, 0x4(sp)
    stwu    sp, -0x38(sp)
    stw     r31, 0x34(sp)
    addi    r31, r3, 0x0
    addi    r3, r2, R2Off_m0x2654
    stw     r30, 0x30(sp)
    addi    r30, r5, unk_80392238@l
    stw     r29, 0x2c(sp)
...
load__9TMareFallFR20JSUMemoryInputStream: # 0x801d7cac
    ...
    lis     r4, unk_803923ec@h
    lwz     r3, R13Off_m0x5fe0(r13)
    addi    r4, r4, unk_803923ec@l
    li      r5, 0x149
    bl      load__18JPAResourceManagerFPCcUs
    li      r0, 0x1
    stb     r0, 0x0(r31)
branch_0x801d7cf4:
    ...
    lis     r4, unk_80392410@h
    lwz     r3, R13Off_m0x5fe0(r13)
    addi    r4, r4, unk_80392410@l
    li      r5, 0x14a
    bl      load__18JPAResourceManagerFPCcUs
    li      r0, 0x1
    stb     r0, 0x0(r31)
...
branch_0x801d7d84:
    ...
    lis     r3, fall_upper_pos@ha
    addi    r4, r3, fall_upper_pos@l
    li      r3, 0x30a2
    li      r5, 0x0
    li      r6, 0x0
    li      r7, 0x0
...
__ct__10TMuddyBoatFPCc: # 0x801d7dfc
    ...
    lis     r3, __vvt__10TMuddyBoat@h
    addi    r3, r3, __vvt__10TMuddyBoat@l
    stw     r3, 0x0(r31)
    addi    r3, r3, 0x24
    li      r0, 0x0
    stw     r3, 0x20(r31)
...
__ct__9TWireBellFPCc: # 0x801d8ea0
    ...
    mr      r31, r3
    bl      __ct__11TMapObjBaseFPCc
    lis     r3, __vvt__9TWireBell@h
    addi    r3, r3, __vvt__9TWireBell@l
    stw     r3, 0x0(r31)
    addi    r3, r3, 0x24
    li      r0, -0x1
    stw     r3, 0x20(r31)
...
__ct__15TMapObjGrowTreeFPCc: # 0x801d9368
    ...
    mr      r31, r3
    bl      __ct__11TMapObjBaseFPCc
    lis     r3, __vvt__15TMapObjGrowTree@h
    addi    r3, r3, __vvt__15TMapObjGrowTree@l
    stw     r3, 0x0(r31)
    addi    r3, r3, 0x24
    li      r0, 0x0
    stw     r3, 0x20(r31)
...
initMapObj__15TMapObjGrowTreeFv: # 0x801d93c8
    ...
    bl      initMapObj__11TMapObjBaseFv
    lfs     f0, -0x25ec(r2)
    lis     r3, unk_80392430@h
    li      r0, 0x168
    stfs    f0, 0x138(r31)
    addi    r4, r3, unk_80392430@l
    lfs     f0, -0x25e8(r2)
    stfs    f0, 0x13c(r31)
    lfs     f0, -0x2670(r2)
    stfs    f0, 0x140(r31)
...
__ct__9TCogwheelFPCc: # 0x801d9d6c
    ...
    mr      r31, r3
    bl      __ct__11TMapObjBaseFPCc
    lis     r3, __vvt__9TCogwheel@h
    addi    r3, r3, __vvt__9TCogwheel@l
    stw     r3, 0x0(r31)
    addi    r3, r3, 0x24
    li      r0, 0x0
    stw     r3, 0x20(r31)
...
initMapObj__9TCogwheelFv: # 0x801d9df8
    ...
    blrl
    lfs     f2, 0x58(sp)
    lis     r3, unk_8039244c@h
    lfs     f1, 0x14(r31)
    addi    r6, sp, 0x38
    lfs     f0, 0x50(sp)
    addi    r3, r3, unk_8039244c@l
    stfs    f0, 0x154(r31)
    addi    r4, sp, 0x50
    addi    r5, r31, 0x30
    stfs    f1, 0x158(r31)
...
__ct__14TCogwheelScaleFPCc: # 0x801da7a0
    ...
    mr      r31, r3
    bl      __ct__11TMapObjBaseFPCc
    lis     r3, __vvt__14TCogwheelScale@h
    addi    r3, r3, __vvt__14TCogwheelScale@l
    stw     r3, 0x0(r31)
    addi    r3, r3, 0x24
    li      r0, 0x0
    stw     r3, 0x20(r31)
...
.globl unk_801db1f8
unk_801db1f8: # 0x801db1f8
    addi    r3, r3, -0x20
    b       __dt__14TCogwheelScaleFv


.globl unk_801db200
unk_801db200: # 0x801db200
    addi    r3, r3, -0x20
    b       __dt__9TCogwheelFv


.globl unk_801db208
unk_801db208: # 0x801db208
    addi    r3, r3, -0x20
    b       __dt__18TMapObjElasticCodeFv


.globl unk_801db210
unk_801db210: # 0x801db210
    addi    r3, r3, -0x20
    b       __dt__15TMapObjGrowTreeFv


.globl unk_801db218
unk_801db218: # 0x801db218
    addi    r3, r3, -0x20
    b       __dt__9TWireBellFv


.globl unk_801db220
unk_801db220: # 0x801db220
    addi    r3, r3, -0x20
    b       __dt__14TMapObjPuncherFv


.globl unk_801db228
unk_801db228: # 0x801db228
    addi    r3, r3, -0x20
    b       __dt__10TMuddyBoatFv


.globl unk_801db230
unk_801db230: # 0x801db230
    addi    r3, r3, -0x20
    b       __dt__9TMareFallFv


.globl unk_801db238
unk_801db238: # 0x801db238
    addi    r3, r3, -0x20
    b       __dt__9TMareCorkFv


.globl unk_801db240
unk_801db240: # 0x801db240
    addi    r3, r3, -0x20
