...
__dt__13TPinnaCoasterFv: # 0x801d3f88
    ...
    lis     r3, __vvt__13TPinnaCoaster@h
    addi    r3, r3, __vvt__13TPinnaCoaster@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    stw     r0, 0x20(r30)
...
initMapObj__13TPinnaCoasterFv: # 0x801d4068
    ...
    lis     r5, unk_80391f98@h
    addi    r4, r3, 0x0
    addi    r3, r5, unk_80391f98@l
    li      r5, 0x3
    lis     r6, 0x1021
    bl      SMS_MakeMActorWithAnmData__FPCcP13MActorAnmDataUlUl
    stw     r3, 0x138(r31)
    lis     r3, unk_80391fb8@h
    addi    r4, r3, unk_80391fb8@l
    lwz     r3, 0x138(r31)
...
moveObject__8TAmiKingFv: # 0x801d44f0
    mflr    r0
    lis     r4, unk_80391ea0@h
    stw     r0, 0x4(sp)
    stwu    sp, -0xd8(sp)
    stw     r31, 0xd4(sp)
    addi    r31, r4, unk_80391ea0@l
    stw     r30, 0xd0(sp)
    addi    r30, r3, 0x0
    stw     r29, 0xcc(sp)
...
branch_0x801d4674:
    ...
    sth     r0, 0xa4(sp)
    addi    r0, sp, 0xa4
    lis     r4, becomeCalmlyCallback__12TFerrisWheelFUlUl@h
    stw     r0, 0x8(sp)
    addi    r9, r3, 0x0
    addi    r8, r4, becomeCalmlyCallback__12TFerrisWheelFUlUl@l
    lfs     f1, -0x2750(r2)
    addi    r3, r5, 0x0
    addi    r4, r31, 0x1b4
    addi    r5, r9, 0x10
...
initMapObj__8TAmiKingFv: # 0x801d4858
    ...
    lis     r4, unk_80392080@h
    lwz     r3, 0x74(r31)
    addi    r4, r4, unk_80392080@l
    bl      setBck__6MActorFPCc
    lis     r3, unk_80392090@h
    addi    r4, r3, unk_80392090@l
    addi    r3, r31, 0x0
    bl      setAnmSound__10TLiveActorFPCc
    lwz     r0, 0xf0(r31)
    li      r6, 0x0
...
loadAfter__8TAmiKingFv: # 0x801d48e0
    ...
    lis     r4, unk_803920b4@h
    lwz     r3, R13Off_m0x5fe0(r13)
    addi    r4, r4, unk_803920b4@l
    li      r5, 0x184
...
loadAfter__14TPinnaEntranceFv: # 0x801d49cc
    ...
    bl      loadAfter__11TMapObjBaseFv
    lfs     f1, -0x2728(r2)
    lis     r3, unk_803920d0@h
    lfs     f0, -0x2724(r2)
    addi    r6, sp, 0xc
    stfs    f1, 0x18(sp)
    lfs     f1, -0x2750(r2)
    addi    r3, r3, unk_803920d0@l
    stfs    f0, 0xc(sp)
    addi    r4, r31, 0x10
    addi    r5, sp, 0x18
    stfs    f1, 0x1c(sp)
...
load__15TBalloonKoopaJrFR20JSUMemoryInputStream: # 0x801d4a34
    mflr    r0
    lis     r5, unk_80391ea0@h
    stw     r0, 0x4(sp)
    stwu    sp, -0x40(sp)
    stw     r31, 0x3c(sp)
    addi    r31, r3, 0x0
    stw     r30, 0x38(sp)
    addi    r30, r5, unk_80391ea0@l
    stw     r29, 0x34(sp)
...
__ct__13TMerrygoroundFPCc: # 0x801d4d64
    ...
    mr      r31, r3
    bl      __ct__11TMapObjBaseFPCc
    lis     r3, __vvt__13TMerrygoround@h
    addi    r3, r3, __vvt__13TMerrygoround@l
    stw     r3, 0x0(r31)
    li      r6, 0x8
    addi    r0, r3, 0x24
    stw     r0, 0x20(r31)
...
branch_0x801d4ef0:
    addi    r3, r26, 0x0
    addi    r4, r2, R2Off_m0x2714
    bl      strcmp
    cmpwi   r3, 0x0
    beq-    branch_0x801d4f38
    addi    r3, r26, 0x0
    addi    r4, r2, R2Off_m0x2710
    bl      strcmp
    cmpwi   r3, 0x0
    beq-    branch_0x801d4f38
    addi    r3, r26, 0x0
    addi    r4, r2, R2Off_m0x2708
    bl      strcmp
    cmpwi   r3, 0x0
    beq-    branch_0x801d4f38
    addi    r0, r28, 0x18c
...
__ct__9TShellCupFPCc: # 0x801d5308
    ...
    lwz     r3, 0x8(sp)
    bl      __ct__11TMapObjBaseFPCc
    lis     r3, __vvt__9TShellCup@h
    lwz     r31, 0x8(sp)
    addi    r3, r3, __vvt__9TShellCup@l
    stw     r3, 0x0(r31)
    addi    r0, r3, 0x24
    lis     r4, __ct__11TPinnaShellFv@h
    lis     r3, __dt__11TPinnaShellFv@h
    stw     r0, 0x20(r31)
    addi    r5, r3, __dt__11TPinnaShellFv@l
    addi    r4, r4, __ct__11TPinnaShellFv@l
    addi    r3, r31, 0x138
    li      r6, 0x90
    li      r7, 0x6
...
__dt__11TPinnaShellFv: # 0x801d5384
    ...
    lis     r3, __vvt__11TPinnaShell@h
    addi    r3, r3, __vvt__11TPinnaShell@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    stw     r0, 0x20(r30)
...
__ct__11TPinnaShellFv: # 0x801d5408
    ...
    stw     r3, 0x0(r31)
    addi    r0, r3, 0x24
    lis     r4, unk_4000013a@h
    stw     r0, 0x20(r31)
    li      r0, 0x0
    addi    r3, r31, 0x0
    stw     r0, 0x68(r31)
    addi    r4, r4, unk_4000013a@l
    li      r5, 0x1
    lfs     f0, -0x2750(r2)
    lis     r6, 0x8000
    stfs    f0, 0x6c(r31)
...
initMapObj__9TShellCupFv: # 0x801d54b0
    ...
    stmw    r21, 0x54(sp)
    addi    r26, r3, 0x0
    addi    r30, r4, unk_80391ea0@l
    bl      initMapObj__11TMapObjBaseFv
    lis     r3, __vvt__10TDamageObj@ha
    lfs     f25, -0x2750(r2)
    addi    r31, r3, __vvt__10TDamageObj@l
    lfs     f26, -0x26e4(r2)
    lfd     f27, -0x26d0(r2)
    addi    r29, r31, 0x24
    lfs     f28, -0x26e0(r2)
...
loadAfter__9TShellCupFv: # 0x801d5700
    ...
    stw     r28, 0x58(sp)
    bl      loadAfter__11TMapObjBaseFv
    lis     r3, unk_803921b4@h
    addi    r29, r3, unk_803921b4@l
    li      r28, 0x0
    li      r30, 0x0
branch_0x801d5734:
    addi    r0, r30, 0x1c0
...
__ct__7TVikingFPCc: # 0x801d5ec8
    ...
    mr      r31, r3
    bl      __ct__11TMapObjBaseFPCc
    lis     r3, __vvt__17THorizontalViking@h
    addi    r3, r3, __vvt__17THorizontalViking@l
    stw     r3, 0x0(r31)
    addi    r0, r3, 0x24
    lis     r3, __vvt__7TViking@h
    stw     r0, 0x20(r31)
    addi    r5, r3, __vvt__7TViking@l
    addi    r4, r5, 0x24
    lfs     f0, -0x2750(r2)
    li      r0, 0x0
    addi    r3, r31, 0x0
...
initMapObj__7TVikingFv: # 0x801d5fd0
    ...
    addi    r31, r3, 0x0
    stw     r0, 0x14c(r3)
    lis     r3, unk_80392218@h
    addi    r4, r3, unk_80392218@l
    lwz     r3, 0x4(r31)
    bl      strcmp
    cmpwi   r3, 0x0
...
__ct__12TFerrisWheelFPCc: # 0x801d67bc
    ...
    mr      r31, r3
    bl      __ct__11TMapObjBaseFPCc
    lis     r3, __vvt__12TFerrisWheel@h
    addi    r3, r3, __vvt__12TFerrisWheel@l
    stw     r3, 0x0(r31)
    addi    r3, r3, 0x24
    li      r0, 0x0
    stw     r3, 0x20(r31)
...
initMapObj__12TFerrisWheelFv: # 0x801d6814
    ...
    bl      __nwa__FUl
    stw     r3, 0x13c(r31)
    lis     r3, unk_80392224@h
    addi    r29, sp, 0x2c
    lfs     f30, -0x2724(r2)
    addi    r28, sp, 0x38
    lfs     f31, -0x2750(r2)
    addi    r27, sp, 0x44
    addi    r30, r3, unk_80392224@l
    li      r26, 0x0
    b       branch_0x801d68e0
...
__dt__9TShellCupFv: # 0x801d6ea0
    ...
    lis     r3, __dt__11TPinnaShellFv@h
    stw     r0, 0x20(r30)
    addi    r4, r3, __dt__11TPinnaShellFv@l
    addi    r3, r30, 0x138
    li      r5, 0x90
    li      r6, 0x6
    bl      __destroy_arr
...
__sinit_MapObjPinna_cpp: # 0x801d7060
    mflr    r0
    lis     r3, unk_803f99e8@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803f99e8@l
...
.globl unk_801d735c
unk_801d735c: # 0x801d735c
    addi    r3, r3, -0x20
    b       __dt__12TFerrisWheelFv


.globl unk_801d7364
unk_801d7364: # 0x801d7364
    addi    r3, r3, -0x20
    b       __dt__17THorizontalVikingFv


.globl unk_801d736c
unk_801d736c: # 0x801d736c
    addi    r3, r3, -0x20
    b       __dt__7TVikingFv


.globl unk_801d7374
unk_801d7374: # 0x801d7374
    addi    r3, r3, -0x20
    b       __dt__11TPinnaShellFv


.globl unk_801d737c
unk_801d737c: # 0x801d737c
    addi    r3, r3, -0x20
    b       __dt__9TShellCupFv


.globl unk_801d7384
unk_801d7384: # 0x801d7384
    addi    r3, r3, -0x20
    b       __dt__13TMerrygoroundFv


.globl unk_801d738c
unk_801d738c: # 0x801d738c
    addi    r3, r3, -0x20
    b       __dt__24TChangeStageMerrygoroundFv


.globl unk_801d7394
unk_801d7394: # 0x801d7394
    addi    r3, r3, -0x20
    b       __dt__15TBalloonKoopaJrFv


.globl unk_801d739c
unk_801d739c: # 0x801d739c
    addi    r3, r3, -0x20
    b       __dt__14TPinnaEntranceFv


.globl unk_801d73a4
unk_801d73a4: # 0x801d73a4
    addi    r3, r3, -0x20
    b       __dt__16TWaterRecoverObjFv


.globl unk_801d73ac
unk_801d73ac: # 0x801d73ac
    addi    r3, r3, -0x20
    b       __dt__8TAmiKingFv


.globl unk_801d73b4
unk_801d73b4: # 0x801d73b4
    addi    r3, r3, -0x20
