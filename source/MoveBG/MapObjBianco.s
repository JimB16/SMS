...
__ct__14TBellWatermillFPCc: # 0x801c4aec
    ...
    lis     r3, __vvt__14TBellWatermill@ha
    addi    r3, r3, __vvt__14TBellWatermill@l
    stw     r3, 0x0(r31)
    addi    r3, r3, 0x24
    li      r0, 0x0
    stw     r3, 0x20(r31)
...
loadAfter__14TBellWatermillFv: # 0x801c4b68
    mflr    r0
    lis     r4, unk_803913c0@h
    stw     r0, 0x4(sp)
    stwu    sp, -0x68(sp)
    stw     r31, 0x64(sp)
    addi    r31, r4, unk_803913c0@l
    stw     r30, 0x60(sp)
    stw     r29, 0x5c(sp)
    addi    r29, r3, 0x0
...
branch_0x801c4f04:
    ...
    lis     r28, unk_000089b8@ha
    lwz     r3, R13Off_m0x6044(r13)
    addi    r4, r28, unk_000089b8@l
    bl      gateCheck__6MSoundFUl
    clrlwi. r0, r3, 24
    beq-    branch_0x801c4f68
    addi    r3, r28, -0x7648
...
__ct__11TBiancoBellFPCc: # 0x801c54dc
    ...
    lis     r3, __vvt__11TBiancoBell@ha
    addi    r3, r3, __vvt__11TBiancoBell@l
    stw     r3, 0x0(r31)
    addi    r3, r3, 0x24
    li      r0, 0x0
    stw     r3, 0x20(r31)
...
initMapObj__11TBiancoBellFv: # 0x801c552c
    ...
    lis     r4, unk_803914b8@h
    lwz     r3, 0x4(r31)
    addi    r4, r4, unk_803914b8@l
    bl      strcmp
    cmpwi   r3, 0x0
...
branch_0x801c5570:
    lis     r4, unk_803914c4@h
    lwz     r3, 0x4(r31)
    addi    r4, r4, unk_803914c4@l
    bl      strcmp
    cmpwi   r3, 0x0
...
branch_0x801c5668:
    ...
    bl      getFrameCtrl__6MActorFi
    stfs    f31, 0xc(r3)
    lis     r31, unk_000089b8@ha
    addi    r4, r31, unk_000089b8@l
    lwz     r3, R13Off_m0x6044(r13)
    bl      gateCheck__6MSoundFUl
    clrlwi. r0, r3, 24
...
__ct__15TLampSeesawMainFPCc: # 0x801c5804
    ...
    mr      r31, r3
    bl      __ct__11TMapObjBaseFPCc
    lis     r3, __vvt__11TLampSeesaw@ha
    addi    r3, r3, __vvt__11TLampSeesaw@l
    stw     r3, 0x0(r31)
    addi    r0, r3, 0x24
    lis     r3, __vvt__15TLampSeesawMain@ha
    stw     r0, 0x20(r31)
    li      r0, 0x0
    addi    r4, r3, __vvt__15TLampSeesawMain@l
    stw     r0, 0x138(r31)
    addi    r0, r4, 0x24
    addi    r3, r31, 0x0
    lfs     f0, -0x2a20(r2)
...
loadAfter__15TLampSeesawMainFv: # 0x801c5910
    mflr    r0
    lis     r4, unk_803914dc@h
    stw     r0, 0x4(sp)
    addi    r0, r4, unk_803914dc@l
    stwu    sp, -0x90(sp)
    stmw    r25, 0x74(sp)
    addi    r31, r3, 0x0
    mr      r3, r0
    ...
    lwz     r6, 0x4(r31)
    addi    r29, r3, 0x0
    lis     r3, unk_803914f0@h
    crxor   6, 6, 6
    add     r4, r6, r29
    lbzx    r28, r6, r29
    addi    r5, r3, unk_803914f0@l
    lbz     r27, 0x1(r4)
    addi    r3, sp, 0x28
    lbz     r26, 0x2(r4)
    lbz     r25, 0x3(r4)
...
__ct__15TLeafBoatRottenFPCc: # 0x801c5d44
    ...
    lis     r3, __vvt__15TLeafBoatRotten@ha
    addi    r3, r3, __vvt__15TLeafBoatRotten@l
    stw     r3, 0x0(r31)
    addi    r0, r3, 0x24
    li      r4, 0x0
    stw     r0, 0x20(r31)
...
__dt__9TLeafBoatFv: # 0x801c5da4
    ...
    lis     r3, __vvt__9TLeafBoat@ha
    addi    r3, r3, __vvt__9TLeafBoat@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    stw     r0, 0x20(r30)
...
__ct__19TBiancoMiniWindmillFPCc: # 0x801c6a1c
    ...
    lis     r3, __vvt__19TBiancoMiniWindmill@ha
    lwz     r30, 0x8(sp)
    addi    r3, r3, __vvt__19TBiancoMiniWindmill@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    stw     r0, 0x20(r30)
    bl      rand
...
initMapObj__19TBiancoMiniWindmillFv: # 0x801c6ae8
    ...
    lis     r3, unk_80391508@h
    addi    r4, r3, unk_80391508@l
    addi    r3, r30, 0x0
...
__ct__24TBiancoWatermillVerticalFPCc: # 0x801c6f2c
    ...
    mr      r31, r3
    bl      __ct__11TMapObjBaseFPCc
    lis     r3, __vvt__24TBiancoWatermillVertical@ha
    addi    r3, r3, __vvt__24TBiancoWatermillVertical@l
    stw     r3, 0x0(r31)
    addi    r3, r3, 0x24
    li      r0, 0x0
    stw     r3, 0x20(r31)
...
__ct__16TBiancoWatermillFPCc: # 0x801c7468
    ...
    mr      r31, r3
    bl      __ct__11TMapObjBaseFPCc
    lis     r3, __vvt__16TBiancoWatermill@ha
    addi    r3, r3, __vvt__16TBiancoWatermill@l
    stw     r3, 0x0(r31)
    addi    r3, r3, 0x24
    li      r0, 0x0
    stw     r3, 0x20(r31)
...
initMapObj__16TBiancoWatermillFv: # 0x801c74bc
    ...
    mr      r31, r3
    bl      initMapObj__11TMapObjBaseFv
    lis     r4, unk_8039155c@h
    lwz     r3, 0xf4(r31)
    addi    r4, r4, unk_8039155c@l
    bl      strcmp
    cmpwi   r3, 0x0
...
branch_0x801c74f8:
    lis     r4, unk_8039156c@h
    lwz     r3, 0xf4(r31)
    addi    r4, r4, unk_8039156c@l
    bl      strcmp
    cmpwi   r3, 0x0
...
branch_0x801c7674:
    ...
    lfs     f2, -0x79d0(r13)
    lfs     f3, -0x79cc(r13)
    lwz     r4, R13Off_m0x79c8(r13)
    bl      tremble__19TTrembleModelEffectFfffi
    lwz     r0, R13Off_m0x79c8(r13)
    stw     r0, 0x104(r31)
branch_0x801c769c:
    lwz     r0, 0x2c(sp)
    lwz     r31, 0x24(sp)
...
load__12TBigWindmillFR20JSUMemoryInputStream: # 0x801c76b0
    ...
    mr      r24, r3
    bl      load__11TMapObjBaseFR20JSUMemoryInputStream
    lis     r3, unk_8039157c@h
    lfs     f30, -0x2a40(r2)
    lfs     f31, -0x2a78(r2)
    addi    r29, sp, 0x10
    addi    r28, sp, 0x1c
    addi    r27, sp, 0x28
    addi    r30, r3, unk_8039157c@l
    li      r25, 0x0
    li      r31, 0x0
branch_0x801c76f4:
    stfs    f30, 0x10(sp)
...
__dt__15TLampSeesawMainFv: # 0x801c7a54
    ...
    lis     r3, __vvt__15TLampSeesawMain@ha
    addi    r3, r3, __vvt__15TLampSeesawMain@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    stw     r0, 0x20(r30)
...
__sinit_MapObjBianco_cpp: # 0x801c7e38
    mflr    r0
    lis     r3, unk_803f96f0@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803f96f0@l
