...
work__14TMapObjGeneralFv: # 0x801b3f2c
    ...
    lis     r4, unk_803c8d08@ha
    addi    r4, r4, unk_803c8d08@l
    slwi    r0, r0, 2
    lwzx    r0, r4, r0
    mtctr   r0
    bctr       
...
thrown__14TMapObjGeneralFv: # 0x801b49f8
    ...
    stfs    f1, 0x14(r3)
    stfs    f2, 0x18(r3)
    lwz     r3, R13Off_m0x60b0(r13)
    lwz     r7, R13Off_m0x60ac(r13)
    lha     r0, 0x0(r3)
    lha     r3, 0x0(r7)
    xoris   r0, r0, 0x8000
    lwz     r8, R13Off_m0x60a8(r13)
    stw     r0, 0x84(sp)
    xoris   r3, r3, 0x8000
    lha     r0, 0x0(r8)
    stw     r6, 0x80(sp)
...
__sinit_MapObjGeneral_cpp: # 0x801b5024
    mflr    r0
    lis     r3, unk_803f91e8@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803f91e8@l
