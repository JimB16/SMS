...
branch_0x8031977c:
    ...
    lwz     r0, R13Off_m0x5b14(r13)
    addi    r4, r2, R2Off_0x750
    lwz     r3, R13Off_m0x5b20(r13)
    slwi    r0, r0, 2
    lwzx    r3, r3, r0
    bl      strcpy
    b       branch_0x803197d4
...
branch_0x803197d4:
    ...
    lwzx    r4, r4, r0
    stw     r30, 0x8(r4)
    lwz     r4, R13Off_m0x5b14(r13)
    addi    r0, r4, 0x1
    stw     r0, R13Off_m0x5b14(r13)
branch_0x80319824:
    lwz     r0, 0x2c(sp)
    lwz     r31, 0x24(sp)
    lwz     r30, 0x20(sp)
...
initVloadBuffers__Q28JASystem5VloadFv: # 0x80319ac4
    ...
    stw     r31, 0xc(sp)
    stw     r30, 0x8(sp)
    lwz     r0, R13Off_m0x73b8(r13)
    lwz     r4, R13Off_m0x5b30(r13)
    slwi    r3, r0, 2
    bl      __nwa__FUlP7JKRHeapi
    lwz     r0, R13Off_m0x73b8(r13)
    li      r5, 0x0
    stw     r3, R13Off_m0x5b20(r13)
    lwz     r4, R13Off_m0x5b30(r13)
    slwi    r3, r0, 2
    bl      __nwa__FUlP7JKRHeapi
    lwz     r0, R13Off_m0x73b8(r13)
    li      r5, 0x0
    stw     r3, R13Off_m0x5b1c(r13)
    lwz     r4, R13Off_m0x5b30(r13)
    slwi    r3, r0, 2
    bl      __nwa__FUlP7JKRHeapi
    stw     r3, R13Off_m0x5b18(r13)
    li      r30, 0x0
    li      r31, 0x0
    b       branch_0x80319b64
