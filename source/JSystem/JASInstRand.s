...
getY__Q28JASystem9TInstRandCFii: # 0x80310070
    ...
    stw     r31, 0x34(sp)
    addi    r31, r3, 0x0
    lbz     r0, R13Off_m0x5c90(r13)
    extsb.  r0, r0
    bne-    branch_0x803100a4
    addi    r3, r13, R13Off_m0x5c8c
    li      r4, 0x0
    bl      __ct__Q25JMath13TRandom_fast_FUl
    li      r0, 0x1
    stb     r0, R13Off_m0x5c90(r13)
branch_0x803100a4:
    lis     r3, unk_0019660d@h
    lwz     r4, R13Off_m0x5c8c(r13)
    ...
    addis   r3, r3, 0x3c6f
    addi    r0, r3, -0xca1
    stw     r0, R13Off_m0x5c8c(r13)
    lwz     r0, R13Off_m0x5c8c(r13)
    srwi    r0, r0, 9
    oris    r0, r0, 0x3f80
    stw     r0, 0x2c(sp)
    lfs     f3, 0x2c(sp)
