...
branch_0x80339708:
    stw     r3, 0x8(sp)
    lis     r0, unk_01ffffff@ha
    addi    r30, r3, 0x0
    stw     r4, 0xc(sp)
    addi    r31, r0, unk_01ffffff@l
    stw     r5, 0x10(sp)
...
branch_0x8033a14c:
    ...
    lis     r3, unk_803aac88@ha
    addi    r28, r28, -0x5
    addi    r4, r3, unk_803aac88@l
    addi    r3, r28, 0x0
    addi    r4, r4, 0x1
    bl      strcpy
    b       branch_0x8033a18c
...
branch_0x8033a830:
    ...
    lis     r5, unk_803e6558@h
    addi    r5, r5, unk_803e6558@l
    slwi    r0, r0, 2
    lwzx    r0, r5, r0
    mtctr   r0
    bctr       
...
branch_0x8033aae8:
    ...
    lis     r9, unk_803e65dc@h
    addi    r9, r9, unk_803e65dc@l
    slwi    r10, r10, 2
    lwzx    r9, r9, r10
    mtctr   r9
    bctr       
...
branch_0x8033ad48:
    lis     r4, unk_803e6730@h
    addi    r4, r4, unk_803e6730@l
branch_0x8033ad50:
    addi    r0, r3, -0x20
    cmplwi  r0, 0x10
    li      r5, 0x1
...
branch_0x8033ae20:
    lis     r4, unk_803aa988@ha
    addi    r5, r4, unk_803aa988@l
    b       branch_0x8033ae48
...
branch_0x8033afb8:
    ...
    lis     r3, unk_803e6660@h
    addi    r3, r3, unk_803e6660@l
    slwi    r0, r0, 2
    lwzx    r0, r3, r0
    mtctr   r0
    bctr       
