...
setFixedStageValue__13TMenuDirectorFv: # 0x802a296c
    stwu    sp, -0x58(sp)
    lis     r4, unk_803a3d48@h
    addi    r5, r4, unk_803a3d48@l
    lwz     r6, 0x40(r3)
    lwz     r0, 0x2c(r6)
    stw     r0, 0x48(r3)
    lwz     r4, 0x44(r3)
...
direct__13TMenuDirectorFv: # 0x802a2da4
    ...
    mr      r31, r3
    lbz     r0, 0x50(r3)
    lis     r3, unk_803a3d28@h
    addi    r30, r3, unk_803a3d28@l
    cmplwi  r0, 0x0
...
branch_0x802a2dec:
    ...
    lis     r28, unk_00030007@h
    lwz     r3, R13Off_m0x6060(r13)
    addi    r4, r28, unk_00030007@l
...
branch_0x802a2ed4:
    ...
    lis     r3, unk_00010366@h
    addi    r27, r3, unk_00010366@l
    addi    r28, r3, 0x3b4
    b       branch_0x802a2f04
...
branch_0x802a2f14:
    ...
    li      r27, 0x0
    lis     r28, unk_73745f61@h
branch_0x802a2f70:
    cmpwi   r27, 0x9
    addis   r4, r27, 0x7374
    addi    r4, r4, 0x5f31
    bne-    branch_0x802a2f84
    addi    r4, r28, unk_73745f61@l
branch_0x802a2f84:
    lwz     r3, 0x3c(r31)
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
...
branch_0x802a2fd4:
    ...
    lwz     r3, 0x3c(r31)
    lis     r28, unk_73745f66@h
    addi    r4, r28, unk_73745f66@l
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
...
branch_0x802a3164:
    ...
    lwz     r3, 0x3c(r31)
    lis     r28, unk_73745f62@h
    addi    r4, r28, unk_73745f62@l
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
...
rsetup__13TMenuDirectorFv: # 0x802a369c
    mflr    r0
    lis     r4, unk_803a3d28@h
    stw     r0, 0x4(sp)
    li      r5, 0x0
    li      r6, 0x0
    stwu    sp, -0x2f0(sp)
    stmw    r26, 0x2d8(sp)
    addi    r30, r4, unk_803a3d28@l
    addi    r31, r3, 0x0
    addi    r3, r30, 0xb4
    li      r4, 0x0
...
branch_0x802a3898:
    ...
    bl      insert__Q27JGadget18TList_pointer_voidFQ37JGadget36TList_Pv_Q27JGadget14TAllocator_Pv__8iteratorRCPv
    lwz     r3, 0x3c(r31)
    lis     r4, unk_6c697341@h
    addi    r4, r4, unk_6c697341@l
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
    stw     r3, 0x20(r31)
    lis     r3, unk_73746174@h
    li      r29, 0x0
    lwz     r5, 0x20(r31)
    addi    r4, r3, unk_73746174@l
    stb     r29, 0xc(r5)
    lwz     r3, 0x3c(r31)
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
...
branch_0x802a3954:
    ...
    addi    r3, r3, __vvt__10TFlashPane@l
    sth     r29, 0xc(r26)
    li      r0, 0x4
    stw     r3, 0x0(r26)
    stw     r28, 0x10(r26)
...
branch_0x802a39ac:
    ...
    lwz     r3, 0x3c(r31)
    lis     r4, unk_6c697342@h
    addi    r4, r4, unk_6c697342@l
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
...
branch_0x802a3a5c:
    ...
    lwz     r3, 0x3c(r31)
    lis     r4, unk_6c697343@h
    addi    r4, r4, unk_6c697343@l
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
...
branch_0x802a3b18:
    ...
    lwz     r5, 0x44(r31)
    li      r0, 0xa
    lis     r3, unk_73746167@h
    stb     r0, 0x3c(r5)
    li      r28, 0x0
    addi    r4, r3, unk_73746167@l
    lwz     r3, 0x14(r5)
    stb     r28, 0xc(r3)
    lhz     r0, 0xc(r5)
    ori     r0, r0, 0x1
...
setup__13TMenuDirectorFPQ26JDrama8TDisplayP13TMarioGamePad: # 0x802a3fb8
    ...
    stw     r28, 0x28(sp)
    lis     r3, unk_803a3ea4@h
    addi    r4, r3, unk_803a3ea4@l
    stw     r28, 0x38(sp)
    lwz     r3, 0x28(sp)
    stw     r28, 0x30(sp)
    ...
    lwz     r5, 0x38(sp)
    lis     r3, unk_803a3eb4@h
    addi    r4, r3, unk_803a3eb4@l
    stw     r0, 0x0(r5)
    addi    r27, r5, 0x20
    stw     r27, 0x20(sp)
    lwz     r3, 0x20(sp)
...
branch_0x802a4084:
    ...
    li      r0, 0x1
    stw     r31, 0x2c(r29)
    lis     r3, setupThreadFunc__13TMenuDirectorFPv@h
    addi    r28, r4, gSetupThread@l
    lwz     r5, 0x2c(r29)
    addi    r4, r3, setupThreadFunc__13TMenuDirectorFPv@l
    addi    r3, r28, 0x0
    sth     r0, 0xe2(r5)
    mr      r5, r29
    lis     r7, 0x1
...
__dt__13TMenuDirectorFv: # 0x802a4104
    ...
    lis     r3, __vvt__13TMenuDirector@ha
    addi    r3, r3, __vvt__13TMenuDirector@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x20
    addi    r3, r2, R2Off_m0x440
    stw     r0, 0xc(r30)
    lwz     r4, 0x2c(r30)
    lhz     r0, 0xe2(r4)
    clrrwi  r0, r0, 1
...
__ct__13TMenuDirectorFv: # 0x802a41bc
    ...
    stw     r30, 0x10(sp)
    stw     r3, 0x8(sp)
    lis     r3, unk_803a3ec0@h
    addi    r3, r3, unk_803a3ec0@l
    lwz     r30, 0x8(sp)
    stw     r0, 0x0(r30)
    stw     r3, 0x4(r30)
    bl      calcKeyCode__Q26JDrama8TNameRefFPCc
...
__sinit_MenuDir_cpp: # 0x802a4290
    mflr    r0
    lis     r3, unk_803fcb30@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803fcb30@l
