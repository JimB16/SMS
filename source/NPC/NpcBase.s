...
__dt__8TBaseNPCFv: # 0x80206298
    ...
    lis     r3, __vvt__8TBaseNPC@ha
    addi    r3, r3, __vvt__8TBaseNPC@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    addi    r3, r30, 0x0
    stw     r0, 0x20(r30)
...
getPtrInitPollutionColor__8TBaseNPCCFv: # 0x80206304
    ...
    lis     r3, unk_803d855c@ha
    addi    r3, r3, unk_803d855c@l
    slwi    r4, r4, 2
    lwzx    r0, r3, r4
    mtctr   r0
    bctr       
...
branch_0x80206368:
    ...
    lis     r3, unk_0400000a@h
    addi    r0, r3, unk_0400000a@l
    cmpw    r6, r0
    li      r4, 0x0
...
branch_0x802063bc:
    ...
    lis     r3, unk_04000013@h
    lwz     r4, 0x4c(r30)
    addi    r0, r3, unk_04000013@l
    cmpw    r4, r0
    li      r5, 0x0
...
branch_0x8020691c:
    ...
    lis     r31, unk_00008017@ha
    lwz     r3, R13Off_m0x6044(r13)
    addi    r4, r31, unk_00008017@l
...
branch_0x80206964:
    lis     r3, unk_01000006@h
    lwz     r4, 0xf0(r28)
    addi    r0, r3, unk_01000006@l
    and.    r0, r4, r0
...
branch_0x80207198:
    ...
    bl      updateSquareToMario__11TSpineEnemyFv
    lfs     f0, -0x1d48(r2)
    lis     r3, unk_400000cd@h
    addi    r4, r3, unk_400000cd@l
    stfs    f0, 0x9c(r31)
    stfs    f0, 0x98(r31)
    stfs    f0, 0x94(r31)
    stfs    f0, 0xa8(r31)
...
branch_0x80207474:
    ...
    lis     r3, unk_803d85dc@ha
    addi    r3, r3, unk_803d85dc@l
    slwi    r4, r4, 2
    lwzx    r0, r3, r4
    mtctr   r0
    bctr       
...
branch_0x80207588:
    ...
    lis     r3, unk_803d85b4@ha
    addi    r3, r3, unk_803d85b4@l
    slwi    r4, r4, 2
    lwzx    r0, r3, r4
    mtctr   r0
    bctr       
...
branch_0x8020777c:
    ...
    beq-    branch_0x80207878
branch_0x802077ac:
    lis     r3, unk_0400000e@h
    addi    r0, r3, unk_0400000e@l
    cmpw    r4, r0
    li      r0, 0x0
...
isBehaveToWaterNpc__8TBaseNPCCFv: # 0x80207910
    ...
    lis     r4, unk_803d8638@ha
    addi    r4, r4, unk_803d8638@l
    slwi    r5, r5, 2
    lwzx    r0, r4, r5
    mtctr   r0
    bctr       
...
isMadNpc__8TBaseNPCCFv: # 0x80207948
    ...
    stw     r29, 0x14(sp)
    addi    r29, r3, 0x0
    lis     r3, unk_04000006@h
    lwz     r4, 0x4c(r29)
    addi    r0, r3, unk_04000006@l
    cmpw    r4, r0
...
branch_0x802079c4:
    lis     r3, unk_0400000d@h
    lwz     r4, 0x4c(r29)
    addi    r0, r3, unk_0400000d@l
    cmpw    r4, r0
...
isPollutionNpc__8TBaseNPCCFv: # 0x80207bc4
    ...
    lis     r4, unk_803d8694@ha
    addi    r4, r4, unk_803d8694@l
    slwi    r5, r5, 2
    lwzx    r0, r4, r5
    mtctr   r0
    bctr       
...
__sinit_NpcBase_cpp: # 0x8020836c
    mflr    r0
    lis     r3, unk_803fad90@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803fad90@l
