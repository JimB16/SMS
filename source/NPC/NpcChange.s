...
setPosAndInitAfterSinkBottom__8TBaseNPCFv: # 0x80212d44
    ...
    lis     r4, unk_f539ffe0@ha
    lwz     r5, 0xf0(r31)
    addi    r0, r4, unk_f539ffe0@l
    and     r0, r5, r0
    stw     r0, 0xf0(r31)
    li      r0, 0x0
    addi    r30, r3, 0x0
...
branch_0x802131bc:
    ...
    cmplwi  r0, 0x0
    bne-    branch_0x802133e4
    lis     r3, unk_00c10207@h
    lwz     r4, 0xf0(r28)
    addi    r0, r3, unk_00c10207@l
    and.    r0, r4, r0
    bne-    branch_0x802133e4
    lwz     r0, 0x170(r28)
...
branch_0x802136f0:
    ...
    beq-    branch_0x80213794
    lfs     f0, 0x14(r28)
    lis     r3, unk_f7fdffff@ha
    addi    r0, r3, unk_f7fdffff@l
    stfs    f0, 0x1c4(r28)
    mr      r3, r28
    lfs     f0, -0x1a48(r2)
    stfs    f0, 0xac(r28)
...
isNowCanTaken__8TBaseNPCCFv: # 0x802137b0
    ...
    cmplwi  r0, 0x0
    bne-    branch_0x802138c0
    lis     r4, unk_00840007@h
    addi    r0, r4, unk_00840007@l
    and.    r0, r5, r0
    bne-    branch_0x802138c0
    lwz     r0, 0x64(r3)
    clrlwi. r0, r0, 31
...
branch_0x80213bfc:
    ...
    lis     r31, unk_00008837@ha
    lwz     r3, R13Off_m0x6044(r13)
    addi    r4, r31, unk_00008837@l
    bl      gateCheck__6MSoundFUl
    clrlwi. r0, r3, 24
...
behaveToBeTrampled___8TBaseNPCFv: # 0x80213fe0
    ...
    lis     r4, unk_00008826@ha
    addi    r29, r3, 0x0
    addi    r3, r30, 0x0
    addi    r31, r4, unk_00008826@l
    li      r28, 0x1
...
branch_0x80214038:
    ...
    lis     r3, unk_000088ab@ha
    addi    r31, r3, unk_000088ab@l
    b       branch_0x802141bc

branch_0x80214054:
    lis     r3, unk_00008844@ha
    addi    r31, r3, unk_00008844@l
    b       branch_0x802141bc
...
branch_0x80214088:
    ...
    lis     r3, unk_000088ac@ha
    addi    r31, r3, unk_000088ac@l
    b       branch_0x802141bc

branch_0x802140a4:
    lis     r3, unk_00008845@ha
    addi    r31, r3, unk_00008845@l
    b       branch_0x802141bc
...
branch_0x802140d8:
    ...
    lis     r3, unk_000088ad@ha
    addi    r31, r3, unk_000088ad@l
    b       branch_0x802141bc
...
branch_0x80214118:
    lis     r3, unk_000088af@ha
    addi    r31, r3, unk_000088af@l
    b       branch_0x802141bc

branch_0x80214124:
    lis     r3, unk_00008846@ha
    addi    r31, r3, unk_00008846@l
    b       branch_0x802141bc
...
branch_0x80214158:
    ...
    lis     r3, unk_000088ae@ha
    addi    r31, r3, unk_000088ae@l
    b       branch_0x802141bc

branch_0x80214174:
    lis     r3, unk_00008847@ha
    addi    r31, r3, unk_00008847@l
    b       branch_0x802141bc
...
branch_0x802141a8:
    lis     r3, unk_00008849@ha
    addi    r31, r3, unk_00008849@l
    b       branch_0x802141bc

branch_0x802141b4:
    lis     r3, unk_00008848@ha
    addi    r31, r3, unk_00008848@l
branch_0x802141bc:
    lwz     r3, R13Off_m0x6044(r13)
    mr      r4, r31
    bl      gateCheck__6MSoundFUl
...
behaveToBeTaken___8TBaseNPCFP9THitActor: # 0x802144e8
    ...
    subf    r0, r31, r3
    sth     r0, -0x621c(r13)
    lis     r3, unk_ffbdffef@ha
    addi    r0, r3, unk_ffbdffef@l
    lwz     r4, 0x18c(r29)
    lwz     r3, 0x0(r4)
    stw     r3, 0x8(r4)
    lwz     r3, 0x64(r29)
...
__sinit_NpcChange_cpp: # 0x80214d08
    mflr    r0
    lis     r3, unk_803fafc0@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803fafc0@l
