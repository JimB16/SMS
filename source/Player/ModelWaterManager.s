...
branch_0x8027c450:
    ...
    bl      GXSetTexCoordGen2
    lbz     r0, 0x5d5f(r31)
    lis     r3, gModelWaterManagerWaterColor@ha
    addi    r4, sp, 0x2c
    slwi    r5, r0, 2
    addi    r0, r3, gModelWaterManagerWaterColor@l
    add     r3, r0, r5
    lwz     r0, 0x0(r3)
    li      r3, 0x1
    stw     r0, 0x2c(sp)
...
drawShineShadowVolume__18TModelWaterManagerFPA4_f: # 0x8027c67c
    ...
    lbz     r0, R13Off_m0x6077(r13)
    extsb.  r0, r0
    bne-    branch_0x8027c6cc
    li      r3, 0x0
    li      r0, 0x1
    stb     r3, R13Off_m0x6078(r13)
    stb     r0, R13Off_m0x6077(r13)
branch_0x8027c6cc:
    lbz     r0, R13Off_m0x6078(r13)
    cmplwi  r0, 0x0
    bne-    branch_0x8027c6f8
    lis     r3, tmp_data@ha
    addi    r0, r3, tmp_data@l
    stw     r0, R13Off_m0x6080(r13)
    li      r0, 0x1
    lwz     r3, R13Off_m0x6080(r13)
    stb     r0, R13Off_m0x6078(r13)
    addi    r0, r3, 0x760
    stw     r0, R13Off_m0x607c(r13)
branch_0x8027c6f8:
    lis     r3, unk_803a1c94@h
    lfd     f1, -0x830(r2)
    addi    r4, r3, unk_803a1c94@l
    lwz     r3, 0x0(r4)
    lis     r28, 0x4330
    lwz     r0, 0x4(r4)
    stw     r3, 0x30(sp)
...
move__18TModelWaterManagerFv: # 0x8027ea48
    ...
    lis     r16, 0x4330
    lfs     f0, 0x5e08(r3)
    lis     r3, unk_803fc2a8@ha
    lfs     f30, -0x834(r2)
    addi    r30, r3, unk_803fc2a8@l
    fmuls   f23, f0, f0
    lfd     f29, -0x808(r2)
    lfd     f28, -0x800(r2)
    lfs     f27, -0x828(r2)
...
branch_0x8027f284:
    lbz     r0, R13Off_m0x6084(r13)
    extsb.  r0, r0
    bne-    branch_0x8027f298
    li      r0, 0x1
    stb     r0, R13Off_m0x6084(r13)
branch_0x8027f298:
    add     r19, r31, r20
    addi    r24, r19, 0x2014
    addi    r25, r29, 0x818
...
loadAfter__18TModelWaterManagerFv: # 0x80280088
    mflr    r0
    lis     r4, unk_803a1ca0@h
    stw     r0, 0x4(sp)
    stwu    sp, -0x70(sp)
    stw     r31, 0x6c(sp)
    addi    r31, r4, unk_803a1ca0@l
    stw     r30, 0x68(sp)
    stw     r29, 0x64(sp)
    addi    r29, r3, 0x0
    addi    r3, r31, 0x0
...
load__18TModelWaterManagerFR20JSUMemoryInputStream: # 0x80280184
    mflr    r0
    lis     r6, unk_803a1a08@h
    stw     r0, 0x4(sp)
    lis     r5, unk_803fc2a8@ha
    stwu    sp, -0x78(sp)
    stfd    f31, 0x70(sp)
    stfd    f30, 0x68(sp)
    stfd    f29, 0x60(sp)
    ...
    stmw    r22, 0x28(sp)
    addi    r31, r3, 0x0
    addi    r30, r6, unk_803a1a08@l
    addi    r28, r5, unk_803fc2a8@l
...
branch_0x802802a8:
    ...
    lfs     f0, -0x7bc(r2)
    stfs    f0, 0x5d1c(r31)
    lwz     r0, R2Off_m0x870(r2)
    stw     r0, 0x20(sp)
    lwz     r0, 0x20(sp)
    stw     r0, 0x5d20(r31)
    lwz     r0, R2Off_m0x86c(r2)
    stw     r0, 0x1c(sp)
    lwz     r0, 0x1c(sp)
    stw     r0, 0x5d24(r31)
    lfs     f0, -0x7b8(r2)
...
branch_0x80280404:
    ...
    sth     r0, 0x5d60(r31)
    li      r0, 0xff
    addi    r26, r5, prmNames@l
    stb     r7, 0x5d62(r31)
    addi    r27, r4, __vvt__10TParamT_f_@l
...
__ct__14TWaterEmitInfoFPCc: # 0x802806f4
    ...
    li      r25, 0x0
    stw     r4, 0x0(r3)
    lis     r3, unk_803a1a08@h
    addi    r30, r3, unk_803a1a08@l
    stw     r25, 0x4(r31)
    addi    r3, r2, R2Off_m0x778
    bl      calcKeyCode__Q26JDrama8TNameRefFPCc
    addi    r5, r3, 0x0
    addi    r4, r31, 0x0
    addi    r3, r31, 0x8
    addi    r6, r2, R2Off_m0x778
    bl      __ct__10TBaseParamFP7TParamsUsPCc
    ...
    stw     r26, 0x18(r31)
    addi    r23, r3, __vvt__11TParamRT_l_@l
    addi    r3, r2, R2Off_m0x78c
    stw     r23, 0x8(r31)
    bl      calcKeyCode__Q26JDrama8TNameRefFPCc
    addi    r5, r3, 0x0
    ...
    addi    r3, r2, R2Off_m0x770
    stw     r28, 0x1c(r31)
    bl      calcKeyCode__Q26JDrama8TNameRefFPCc
    addi    r5, r3, 0x0
    addi    r4, r31, 0x0
    addi    r3, r31, 0x30
    addi    r6, r2, R2Off_m0x770
    bl      __ct__10TBaseParamFP7TParamsUsPCc
    stw     r29, 0x30(r31)
    addi    r3, r2, R2Off_m0x768
    sth     r26, 0x40(r31)
    stw     r28, 0x30(r31)
    bl      calcKeyCode__Q26JDrama8TNameRefFPCc
    lfs     f1, -0x834(r2)
    ...
    addi    r27, r3, __vvt__30TParamT_Q29JGeometry8TVec3_f__@l
    stw     r27, 0x44(r31)
    lis     r3, __vvt__9TParamVec@ha
    addi    r26, r3, __vvt__9TParamVec@l
    lwz     r4, 0x34(sp)
    addi    r3, r2, R2Off_m0x760
    lwz     r0, 0x38(sp)
    stw     r4, 0x54(r31)
    stw     r0, 0x58(r31)
    lwz     r0, 0x3c(sp)
    ...
    addi    r4, r31, 0x0
    addi    r3, r31, 0x124
    addi    r6, r2, R2Off_m0x740
    bl      __ct__10TBaseParamFP7TParamsUsPCc
    stw     r24, 0x124(r31)
    addi    r3, r2, R2Off_m0x738
    stw     r25, 0x134(r31)
    stw     r23, 0x124(r31)
    bl      calcKeyCode__Q26JDrama8TNameRefFPCc
    addi    r5, r3, 0x0
...
__sinit_ModelWaterManager_cpp: # 0x80280adc
    ...
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803fc2a8@l
    lis     r3, unk_803a1e54@h
    stw     r30, 0x8(sp)
    addi    r30, r31, 0xc
    addi    r4, r3, unk_803a1e54@l
    addi    r3, r30, 0x0
    ...
    stw     r3, 0xc(r31)
    addi    r0, r3, 0x24
    lis     r4, __dt__14TWaterHitActorFv@ha
    stw     r0, 0x2c(r31)
    addi    r3, r30, 0x0
    addi    r4, r4, __dt__14TWaterHitActorFv@l
    addi    r5, r31, 0x0
