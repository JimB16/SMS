...
__dt__14TSplashManagerFv: # 0x80266a24
    ...
    addi    r3, r3, __vvt__14TSplashManager@l
    addic.  r0, r30, 0x124
    stw     r3, 0x0(r30)
...
load__14TSplashManagerFR20JSUMemoryInputStream: # 0x80267050
    ...
    li      r0, 0x3
    lis     r3, unk_8039ef40@ha
    sth     r0, 0x10(r31)
    addi    r3, r3, unk_8039ef40@l
...
branch_0x8026712c:
    ...
    lis     r4, __vvt__15TDLColorTexQuad@ha
    stw     r0, 0x0(r3)
    addi    r0, r4, __vvt__15TDLColorTexQuad@l
    stw     r0, 0x0(r3)
branch_0x802671a0:
    stw     r3, 0x640(r31)
    li      r4, 0x40
...
__sinit_SplashManager_cpp: # 0x802671e8
    mflr    r0
    lis     r3, unk_803fbd98@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803fbd98@l
