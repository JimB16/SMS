...
branch_0x8024d424:
    ...
    stw     r3, 0x1c(r27)
    addi    r4, sp, 0x118
    lwz     r27, R13Off_m0x70d8(r13)
    mr      r3, r27
    bl      getInCubeNo__16TCubeManagerBaseCFRC3Vec
    stw     r3, 0x1c(r27)
    addi    r4, sp, 0x118
    lwz     r27, R13Off_m0x70d4(r13)
    mr      r3, r27
    bl      getInCubeNo__16TCubeManagerBaseCFRC3Vec
    stw     r3, 0x1c(r27)
    addi    r4, sp, 0x118
    lwz     r27, R13Off_m0x70d0(r13)
    mr      r3, r27
    bl      getInCubeNo__16TCubeManagerBaseCFRC3Vec
    stw     r3, 0x1c(r27)
branch_0x8024d4a4:
...
__sinit_MarioMain_cpp: # 0x8024db28
    mflr    r0
    lis     r3, cDeformedTerrainCenter@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, cDeformedTerrainCenter@l
    lfs     f1, -0x100c(r2)
    stfs    f1, 0x0(r31)
    lfs     f0, -0xffc(r2)
    stfs    f0, 0x4(r31)
