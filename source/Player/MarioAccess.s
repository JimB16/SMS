...
SMS_SetMarioAccessParams__Fv: # 0x80273a0c
    lwz     r8, R13Off_m0x60d8(r13)
    addi    r5, r8, 0x94
    stw     r8, R13Off_m0x60b8(r13)
    addi    r9, r8, 0xa4
    addi    r4, r8, 0x10
    stw     r5, R13Off_m0x60b0(r13)
    addi    r3, r5, 0x2
    addi    r0, r5, 0x4
    stw     r4, R13Off_m0x60b4(r13)
    addi    r7, r9, 0x4
    addi    r6, r9, 0x8
    stw     r3, R13Off_m0x60ac(r13)
    addi    r5, r8, 0xf8
    addi    r4, r8, 0x118
    stw     r0, R13Off_m0x60a8(r13)
    addi    r3, r8, 0x820
    addi    r0, r8, 0xe0
    stw     r9, R13Off_m0x60a4(r13)
    stw     r7, R13Off_m0x60a0(r13)
    stw     r6, R13Off_m0x609c(r13)
    stw     r5, R13Off_m0x6098(r13)
    stw     r4, R13Off_m0x6094(r13)
    stw     r3, R13Off_m0x6090(r13)
    stw     r0, R13Off_m0x608c(r13)
    blr
