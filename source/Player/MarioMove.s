...
playerControl__6TMarioFPQ26JDrama9TGraphics: # 0x8024de38
    ...
    lis     r4, unk_10001308@h
    addi    r3, r30, 0x0
    addi    r4, r4, unk_10001308@l
    li      r5, 0x0
    li      r6, 0x0
...
branch_0x8024e878:
    ...
    bne-    branch_0x8024e92c
    lwz     r6, 0x158(r31)
    lis     r3, unk_8039ec58@ha
    lwz     r5, 0x10(r31)
    addi    r4, r3, unk_8039ec58@l
    lwz     r0, 0x14(r31)
    stw     r5, 0x70(r6)
    stw     r0, 0x74(r6)
    lwz     r0, 0x18(r31)
...
branch_0x8024eda4:
    ...
    lis     r3, unk_803dd140@ha
    addi    r3, r3, unk_803dd140@l
    slwi    r0, r0, 2
    lwzx    r0, r3, r0
    mtctr   r0
    bctr       
...
branch_0x8024faa8:
    clrlwi. r0, r0, 24
    bne-    branch_0x8024fabc
    lis     r3, unk_8001001b@h
    addi    r3, r3, unk_8001001b@l
...
branch_0x8024fb4c:
    ...
    bl      kill__6TYoshiFv
branch_0x8024fb8c:
    lis     r4, unk_000208b9@h
    addi    r3, r31, 0x0
    addi    r4, r4, unk_000208b9@l
    li      r5, 0x0
    li      r6, 0x1
    bl      changePlayerStatus__6TMarioFUlUlb
    lhz     r0, 0xfa(r31)
...
getDmgMapCode__6TMarioCFi: # 0x8025103c
    ...
    lis     r5, unk_803dd168@ha
    addi    r5, r5, unk_803dd168@l
    slwi    r0, r4, 2
    lwzx    r0, r5, r0
    mtctr   r0
    bctr       
...
branch_0x8025279c:
    ...
    mr      r3, r31
    bl      loserExec__6TMarioFv
    lis     r4, unk_10001123@h
    addi    r3, r31, 0x0
    addi    r4, r4, unk_10001123@l
    li      r5, 0x0
    li      r6, 0x0
    bl      changePlayerStatus__6TMarioFUlUlb
branch_0x802527e8:
...
branch_0x80252c3c:
    ...
    lis     r3, unk_803dd1b4@ha
    addi    r3, r3, unk_803dd1b4@l
    slwi    r0, r0, 2
    lwzx    r0, r3, r0
    mtctr   r0
    bctr       
...
branch_0x80253090:
    ...
    lis     r3, unk_803dd190@ha
    addi    r3, r3, unk_803dd190@l
    slwi    r0, r0, 2
    lwzx    r0, r3, r0
    mtctr   r0
    bctr       
...
branch_0x802530c8:
    ...
    bne-    branch_0x80253108
    mr      r3, r31
    bl      checkGraffitoFire__6TMarioFv
    b       branch_0x80253108
...
branch_0x802530dc:
    ...
    bne-    branch_0x80253108
    mr      r3, r31
    bl      checkGraffitoSlip__6TMarioFv
    b       branch_0x80253108
...
branch_0x80253344:
    ...
    lis     r4, unk_00020338@h
    addi    r3, r31, 0x0
    addi    r4, r4, unk_00020338@l
    li      r5, 0x0
    li      r6, 0x0
    bl      changePlayerStatus__6TMarioFUlUlb
    lwz     r3, R13Off_m0x6044(r13)
...
branch_0x8025347c:
    ...
    lfs     f0, 0x264c(r31)
    lis     r4, unk_0004045e@h
    addi    r3, r31, 0x0
    stfs    f0, 0x138(r31)
    addi    r4, r4, unk_0004045e@l
    li      r5, 0x0
    lha     r0, 0x2674(r31)
    li      r6, 0x0
    sth     r0, 0x13c(r31)
...
branch_0x802534fc:
    lfs     f0, 0x264c(r31)
    lis     r4, unk_0084045d@h
    addi    r3, r31, 0x0
    stfs    f0, 0x138(r31)
    addi    r4, r4, unk_0084045d@l
    li      r5, 0x0
    lha     r0, 0x2674(r31)
    li      r6, 0x0
    sth     r0, 0x13c(r31)
...
branch_0x80253544:
    ...
    lis     r4, unk_00040561@h
    addi    r3, r31, 0x0
    addi    r4, r4, unk_00040561@l
    li      r5, 0x0
    li      r6, 0x0
    bl      changePlayerStatus__6TMarioFUlUlb
    b       branch_0x8025359c
...
branch_0x80253584:
    lis     r4, unk_0004045c@h
    addi    r3, r31, 0x0
    addi    r4, r4, unk_0004045c@l
    li      r5, 0x0
    li      r6, 0x0
    bl      changePlayerStatus__6TMarioFUlUlb
branch_0x8025359c:
...
branch_0x8025384c:
    ...
    sth     r0, 0x14c(r31)
    bl      dropObject__6TMarioFv
    lis     r4, unk_000208b7@h
    addi    r3, r31, 0x0
    addi    r4, r4, unk_000208b7@l
    li      r5, 0x1
    li      r6, 0x0
    bl      changePlayerStatus__6TMarioFUlUlb
...
branch_0x80253c84:
    mr      r3, r30
    bl      dropObject__6TMarioFv
    lis     r4, unk_02000885@h
    addi    r3, r30, 0x0
    addi    r4, r4, unk_02000885@l
    li      r5, 0x0
    li      r6, 0x0
    bl      changePlayerStatus__6TMarioFUlUlb
    b       branch_0x80253d34
...
branch_0x80254114:
    fmr     f1, f0
branch_0x80254118:
    lis     r3, unk_04000440@h
    addi    r0, r3, unk_04000440@l
    cmpw    r29, r0
...
branch_0x80254184:
    ...
    lis     r3, unk_00840452@h
    addi    r29, r3, unk_00840452@l
    b       branch_0x802541a0

branch_0x80254198:
    lis     r3, unk_00840453@h
    addi    r29, r3, unk_00840453@l
branch_0x802541a0:
    addi    r3, r30, 0x0
    li      r4, 0x78cf
    bl      startVoice__6TMarioFUl
...
branch_0x80254400:
    lis     r5, unk_000208b4@h
    addi    r0, r5, unk_000208b4@l
    cmpw    r31, r0
...
branch_0x80254488:
    lis     r4, unk_02000885@h
    addi    r0, r4, unk_02000885@l
    cmpw    r31, r0
    beq-    branch_0x802548a4
    bge-    branch_0x802544f0
    lis     r3, unk_0080088a@h
    addi    r0, r3, unk_0080088a@l
    cmpw    r31, r0
...
__sinit_MarioMove_cpp: # 0x802560e4
    mflr    r0
    lis     r3, unk_803fb878@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803fb878@l
