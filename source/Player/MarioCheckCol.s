...
branch_0x80281288:
    lis     r4, unk_1000001e@h
    lfs     f30, -0x72c(r2)
    lis     r5, unk_08000014@h
    lfs     f31, -0x710(r2)
    addi    r0, r4, unk_1000001e@l
    lfs     f28, -0x70c(r2)
    stw     r0, 0xec(sp)
    addi    r0, r5, unk_08000014@l
    lis     r3, unk_40000396@h
    lfs     f29, -0x708(r2)
    stw     r0, 0xbc(sp)
    addi    r0, r4, 0x19
    stw     r0, 0xf0(sp)
    addi    r0, r3, unk_40000396@l
    lis     r6, unk_2000000c@h
    stw     r0, 0x1c0(sp)
    addi    r0, r3, 0x390
    lis     r7, unk_80000001@h
    stw     r0, 0x1bc(sp)
    addi    r0, r3, 0x393
    addi    r14, r4, 0x1
    stw     r0, 0x1b4(sp)
    ...
    stw     r0, 0x19c(sp)
    addi    r0, r3, 0x136
    addi    r21, r7, unk_80000001@l
    stw     r0, 0x194(sp)
    addi    r0, r3, 0x9e
    addi    r27, r6, unk_2000000c@l
    stw     r0, 0x190(sp)
    addi    r0, r3, 0x139
    addi    r26, r4, 0xe
    stw     r0, 0x180(sp)
...
branch_0x80282538:
    ...
    stw     r31, 0x68(r30)
    lis     r4, unk_10100341@h
    addi    r3, r30, 0x0
    lfs     f0, -0x72c(r2)
    addi    r4, r4, unk_10100341@l
    li      r5, 0x0
    stfs    f0, 0xa8(r30)
    li      r6, 0x0
    stfs    f0, 0xb0(r30)
...
branch_0x80282770:
    ...
    cmplwi  r0, 0x0
    beq-    branch_0x802827e0
    lis     r3, mStaticHitActor__18TModelWaterManager@ha
    lwz     r0, 0x10(r30)
    addi    r3, r3, mStaticHitActor__18TModelWaterManager@l
    lwz     r5, 0x14(r30)
    mr      r4, r3
    stw     r0, 0x10(r3)
    li      r0, 0x0
...
__sinit_MarioCheckCol_cpp: # 0x802827f8
    mflr    r0
    lis     r3, unk_803fc400@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803fc400@l
