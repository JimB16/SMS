...
branch_0x802497b8:
    ...
    li      r0, 0x1
    sth     r0, MarioActor_StatusTime(r31)
branch_0x802497dc:
    lhz     r0, MarioActor_StatusTime(r31)
    cmplwi  r0, 0x0
...
branch_0x80249908:
    ...
    li      r0, 0x0
    sth     r0, MarioActor_AngleX(r31)
    lha     r3, MarioActor_9a(r31)
    addis   r3, r3, 0x1
    subi    r0, r3, 0x8000
...
branch_0x80249d5c:
    lwz     r3, MarioActor_LastStatus(r31)
    addis   r0, r3, 0xf000
    cmplwi  r0, 0x358
...
branch_0x80249f30:
    ...
    bl      setAnimation__6TMarioFif
branch_0x80249f6c:
    lwz     r3, MarioActor_PositionX(r31)
    addi    r4, sp, 0x60
    ...
    lwz     r3, 0x60(sp)
    lwz     r0, 0x64(sp)
    stw     r3, MarioActor_PositionX(r31)
    stw     r0, MarioActor_PositionY(r31)
    lwz     r0, 0x68(sp)
    stw     r0, MarioActor_PositionZ(r31)
branch_0x80249fbc:
    li      r30, 0x0
    b       branch_0x8024a28c
