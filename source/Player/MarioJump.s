...
branch_0x8024926c:
    clrlwi. r0, r0, 24
    beq-    branch_0x8024928c
    lis     r4, unk_820008ab@h
    addi    r3, r31, 0x0
    addi    r4, r4, unk_820008ab@l
    li      r5, 0x0
    li      r6, 0x0
    bl      changePlayerStatus__6TMarioFUlUlb
branch_0x8024928c:
    lis     r29, unk_000208b4@h
    lwz     r5, 0x7c(r31)
    addi    r0, r29, unk_000208b4@l
    cmpw    r5, r0
    ...
    lis     r3, unk_820008ab@h
    addi    r0, r3, unk_820008ab@l
    cmpw    r5, r0
...
branch_0x80249380:
    ...
    addi    r0, r4, unk_02000880@l
    cmpw    r5, r0
    beq-    branch_0x80249474
    bge-    branch_0x80249404
    lis     r4, unk_0080088a@h
    addi    r0, r4, unk_0080088a@l
    cmpw    r5, r0
...
branch_0x802493e0:
    lis     r3, unk_0081089b@h
    addi    r0, r3, unk_0081089b@l
    cmpw    r5, r0
...
branch_0x80249450:
    lis     r3, unk_0281089a@h
    addi    r0, r3, unk_0281089a@l
    cmpw    r5, r0
    beq-    branch_0x80249c00
    bge-    branch_0x8024a28c
    addi    r0, r4, 0x890
...
branch_0x802494ec:
    lis     r4, unk_000208b8@h
    addi    r3, r31, 0x0
    addi    r4, r4, unk_000208b8@l
    li      r5, 0x120
    li      r6, 0x0
...
branch_0x80249524:
    li      r5, 0x4c
branch_0x80249528:
    lis     r4, unk_04000470@h
    addi    r3, r31, 0x0
    addi    r4, r4, unk_04000470@l
    li      r6, 0x3
    bl      jumpingBasic__6TMarioFiii
    b       branch_0x80249558
...
branch_0x80249604:
    lis     r4, unk_04000472@h
    addi    r3, r31, 0x0
    addi    r5, r29, 0x0
    addi    r4, r4, unk_04000472@l
    li      r6, 0x3
    bl      jumpingBasic__6TMarioFiii
    li      r0, 0x0
branch_0x80249620:
...
branch_0x8024965c:
    ...
    lis     r4, unk_008008a9@h
    addi    r3, r31, 0x0
    addi    r4, r4, unk_008008a9@l
    li      r5, 0x0
    li      r6, 0x0
    bl      changePlayerStatus__6TMarioFUlUlb
    b       branch_0x802496d0
...
branch_0x802496f8:
    lis     r4, unk_04000478@h
    addi    r3, r31, 0x0
    addi    r4, r4, unk_04000478@l
    li      r5, 0x6f
    li      r6, 0x0
    bl      jumpingBasic__6TMarioFiii
    li      r0, 0x0
...
branch_0x80249908:
    lis     r4, unk_04000473@h
    addi    r3, r31, 0x0
    addi    r4, r4, unk_04000473@l
    li      r5, 0xbf
    li      r6, 0x1
    bl      jumpingBasic__6TMarioFiii
    cmpwi   r3, 0x3
...
branch_0x80249a9c:
    lis     r3, unk_04000470@h
    addi    r4, r3, unk_04000470@l
branch_0x80249aa4:
    addi    r3, r31, 0x0
    li      r5, 0x0
    li      r6, 0x0
...
branch_0x80249af8:
    ...
    lis     r4, unk_00020449@h
    addi    r3, r31, 0x0
    addi    r4, r4, unk_00020449@l
    li      r5, 0x0
    li      r6, 0x0
    bl      changePlayerStatus__6TMarioFUlUlb
branch_0x80249b3c:
...
branch_0x8024a018:
    lis     r3, unk_80000a36@h
    addi    r0, r3, unk_80000a36@l
    stw     r0, 0x7c(r31)
    b       branch_0x8024a034
...
branch_0x8024a080:
    ...
    bl      rumbleStart__6TMarioFii
branch_0x8024a0a4:
    lis     r4, unk_00020463@h
    lfs     f1, -0x1080(r2)
    addi    r3, r31, 0x0
    addi    r4, r4, unk_00020463@l
    li      r5, 0x2d
    bl      jumpDownCommon__6TMarioFiif
    li      r30, 0x0
    b       branch_0x8024a28c
...
branch_0x8024a108:
    ...
    bl      rumbleStart__6TMarioFii
branch_0x8024a12c:
    lis     r4, unk_00020460@h
    lfs     f1, -0x1084(r2)
    addi    r3, r31, 0x0
    addi    r4, r4, unk_00020460@l
    li      r5, 0x2
    bl      jumpDownCommon__6TMarioFiif
    li      r30, 0x0
    b       branch_0x8024a28c
...
branch_0x8024a14c:
    lis     r4, unk_04000471@h
    lfs     f1, 0xb0(r31)
    addi    r3, r31, 0x0
    addi    r4, r4, unk_04000471@l
    li      r5, 0x56
    bl      jumpDownCommon__6TMarioFiif
    li      r30, 0x0
    b       branch_0x8024a28c
...
branch_0x8024a7b8:
    ...
    lfs     f0, -0x1088(r2)
    lis     r4, unk_0080023c@h
    addi    r3, r31, 0x0
    fadds   f0, f0, f1
    addi    r4, r4, unk_0080023c@l
    li      r5, 0x0
    li      r6, 0x0
    stfs    f0, 0x14(r31)
    bl      changePlayerStatus__6TMarioFUlUlb
...
branch_0x8024a8a4:
    ...
    lis     r4, unk_0c000230@h
    addi    r3, r31, 0x0
    addi    r4, r4, unk_0c000230@l
    li      r5, 0x0
    li      r6, 0x0
    bl      changePlayerStatus__6TMarioFUlUlb
    b       branch_0x8024ac44
...
branch_0x8024aa28:
    ...
    li      r4, 0x78d3
    bl      startVoice__6TMarioFUl
    lis     r4, unk_00200346@h
    addi    r3, r31, 0x0
    addi    r4, r4, unk_00200346@l
    li      r5, 0x0
    li      r6, 0x0
    bl      changePlayerStatus__6TMarioFUlUlb
    b       branch_0x8024ac44
...
branch_0x8024b010:
    ...
    li      r4, 0x15
    bl      rumbleStart__6TMarioFii
    lis     r4, unk_08200348@h
    addi    r3, r30, 0x0
    addi    r4, r4, unk_08200348@l
    li      r5, 0x0
    li      r6, 0x0
    bl      changePlayerStatus__6TMarioFUlUlb
branch_0x8024b040:
...
branch_0x8024b238:
    ...
    fcmpo   cr0, f1, f0
    bge-    branch_0x8024b334
    lis     r4, unk_00810446@h
    addi    r3, r31, 0x0
    addi    r4, r4, unk_00810446@l
    li      r5, 0x0
    li      r6, 0x0
    bl      changePlayerStatus__6TMarioFUlUlb
    b       branch_0x8024b334
...
branch_0x8024b4c4:
    lis     r4, unk_0c000223@h
    addi    r3, r31, 0x0
    addi    r4, r4, unk_0c000223@l
    li      r5, 0x0
    li      r6, 0x0
    bl      changePlayerStatus__6TMarioFUlUlb
    b       branch_0x8024b500
...
branch_0x8024b720:
    ...
    li      r4, 0x7852
    bl      startVoice__6TMarioFUl
    lis     r4, unk_08000239@h
    addi    r3, r31, 0x0
    addi    r4, r4, unk_08000239@l
    li      r5, 0x0
    li      r6, 0x0
    bl      changePlayerStatus__6TMarioFUlUlb
    b       branch_0x8024b754
...
branch_0x8024bac0:
    lis     r4, unk_0c000232@h
    addi    r3, r31, 0x0
    addi    r4, r4, unk_0c000232@l
    li      r5, 0x0
    li      r6, 0x0
    bl      changePlayerStatus__6TMarioFUlUlb
    b       branch_0x8024bae8
...
branch_0x8024c0e8:
    ...
    lis     r4, unk_0002033c@h
    addi    r3, r31, 0x0
    addi    r4, r4, unk_0002033c@l
    li      r5, 0x1
    li      r6, 0x0
    bl      changePlayerStatus__6TMarioFUlUlb
    b       branch_0x8024c1b4
...
branch_0x8024c154:
    clrlwi. r0, r0, 24
    beq-    branch_0x8024c174
    lis     r4, unk_3000036c@h
    addi    r3, r31, 0x0
    addi    r4, r4, unk_3000036c@l
    li      r5, 0x0
...
branch_0x8024ca2c:
    ...
    bl      setPlayerVelocity__6TMarioFf
branch_0x8024ca44:
    lis     r4, unk_000208b6@h
    addi    r3, r28, 0x0
    addi    r4, r4, unk_000208b6@l
    li      r5, 0x0
    li      r6, 0x0
    bl      changePlayerStatus__6TMarioFUlUlb
    b       branch_0x8024cac4
...
__sinit_MarioJump_cpp: # 0x8024ce80
    mflr    r0
    lis     r3, unk_803fb700@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803fb700@l
