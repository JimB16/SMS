...
__dt__9TSunModelFv: # 0x8002e9f0
    ...
    lis     r3, __vvt__9TSunModel@ha
    addi    r3, r3, __vvt__9TSunModel@l
    stw     r3, 0x0(r30)
    addi    r3, r3, 0x24
    addic.  r0, r30, 0x50
    stw     r3, 0x20(r30)
...
load__9TSunModelFR20JSUMemoryInputStream: # 0x8002f220
    mflr    r0
    lis     r5, unk_80375798@h
    stw     r0, 0x4(sp)
    stwu    sp, -0x1f8(sp)
    stmw    r25, 0x1dc(sp)
    addi    r30, r3, 0x0
    addi    r31, r5, unk_80375798@l
    ...
    stfs    f0, 0x2c(r30)
    lbz     r0, 0x1ac(r30)
    lwz     r28, R13Off_m0x7fa8(r13)
    rlwinm. r0, r0, 0, 29, 29
    beq-    branch_0x8002f284
    oris    r29, r29, 0x100
    lwz     r28, R13Off_m0x7fa4(r13)
branch_0x8002f284:
    addi    r6, r28, 0x0
    crxor   6, 6, 6
    addi    r3, sp, 0xc4
...
__ct__9TSunModelFbPCc: # 0x8002f570
    ...
    lis     r3, __vvt__9TSunModel@ha
    stw     r0, 0x20(r30)
    addi    r6, r3, __vvt__9TSunModel@l
    lis     r3, __vvt__12J3DFrameCtrl@ha
    lfs     f0, -0x7668(r2)
    addi    r0, r3, __vvt__12J3DFrameCtrl@l
    addi    r5, r6, 0x24
    ...
    stw     r31, 0x64(r30)
    li      r0, 0xff
    lis     r3, __ct__Q29JGeometry8TVec2_s_Fv@ha
    stb     r0, 0x68(r30)
    addi    r4, r3, __ct__Q29JGeometry8TVec2_s_Fv@l
    li      r8, 0x32
    lfs     f1, -0x7648(r2)
    li      r0, 0x64
    addi    r3, r30, 0xb4
