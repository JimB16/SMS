...
branch_0x8018388c:
    ...
    bl      begin__Q29_unnamed_16ArrayWrapper_Ul_CFv
    lwz     r5, 0xc(r28)
    lis     r4, cSoundSettings__16TOptionSoundUnit@h
    addi    r0, r4, cSoundSettings__16TOptionSoundUnit@l
    subf    r3, r3, r5
    srawi   r3, r3, 2
    addze   r3, r3
    slwi    r3, r3, 3
...
movementOption2Card__14TOptionControlFv: # 0x80183c50
    ...
    stw     r29, 0x64(sp)
    mr      r29, r3
    lwz     r4, R13Off_m0x70b8(r13)
    lha     r0, 0x12(r4)
    cmpwi   r0, 0x0
    bne-    branch_0x80183d28
    lwz     r3, 0x0(r29)
    lis     r30, unk_6f796130@h
    addi    r4, r30, unk_6f796130@l
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
...
movementCard2Option__14TOptionControlFv: # 0x80183fc0
    ...
    lwz     r4, 0x8(r28)
    li      r29, 0x0
    lis     r3, unk_74787032@h
    stb     r29, 0x20(r4)
    addi    r4, r3, unk_74787032@l
    lwz     r3, 0x0(r28)
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    ...
    li      r30, 0x1
    stb     r30, 0xc(r3)
    lis     r31, unk_6f796130@h
    addi    r4, r31, unk_6f796130@l
    lwz     r3, 0x0(r28)
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
...
loadSetting__14TOptionControlFv: # 0x801840e8
    mflr    r0
    lis     r4, unk_803c14b0@h
    stw     r0, 0x4(sp)
    stwu    sp, -0x100(sp)
    stmw    r27, 0xec(sp)
    addi    r31, r4, unk_803c14b0@l
    addi    r30, r3, 0x0
    lis     r4, 0xa
    lwz     r0, R13Off_m0x6060(r13)
    mr      r3, r0
...
load__14TOptionControlFv: # 0x801845b8
    ...
    lis     r3, unk_80388b8c@ha
    addi    r4, r3, unk_80388b8c@l
    addi    r3, r29, 0x0
    addi    r5, r30, 0x0
...
branch_0x80184604:
    ...
    lwz     r3, 0x0(r31)
    lis     r30, unk_6d5f3061@h
    addi    r4, r30, unk_6d5f3061@l
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
...
adjustView__16TOptionSoundUnitFv: # 0x8018488c
    ...
    stw     r29, 0x104(sp)
    lwz     r4, 0x10(r3)
    lis     r3, unk_803c14b0@h
    addi    r31, r3, unk_803c14b0@l
    lwz     r3, 0x4(r4)
    lwz     r0, 0xc(r4)
    subf    r0, r3, r0
    srawi   r0, r0, 2
...
typeToFlag__16TOptionSoundUnitFQ216TOptionSoundUnit9SoundType: # 0x80185050
    lis     r4, cFlagInfos__16TOptionSoundUnit@h
    addi    r4, r4, cFlagInfos__16TOptionSoundUnit@l
    addi    r5, r4, 0x0
    addi    r4, r4, 0x18
    b       branch_0x8018507c
...
initSurroundAnm__16TOptionSoundUnitFv: # 0x8018539c
    ...
    stmw    r26, 0x48(sp)
    addi    r29, r3, 0x0
    lis     r3, unk_80388980@ha
    addi    r31, r3, unk_80388980@l
    addi    r30, r29, 0x44
    li      r3, 0x28
    bl      __nw__FUl
    mr.     r26, r3
...
__ct__16TOptionSoundUnitFP9J2DScreen: # 0x80185944
    mflr    r0
    lis     r5, unk_80388980@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x70(sp)
    stmw    r27, 0x5c(sp)
    addi    r31, r5, unk_80388980@l
    stw     r3, 0x8(sp)
    lis     r3, __vvt__12J3DFrameCtrl@ha
    addi    r0, r3, __vvt__12J3DFrameCtrl@l
    lwz     r29, 0x8(sp)
    ...
    stw     r0, 0x18(r29)
    bl      init__12J3DFrameCtrlFs
    lis     r3, __ct__Q29_unnamed_35ArrayWrapper_P18TPatternAnmControl_Fv@h
    addi    r4, r3, __ct__Q29_unnamed_35ArrayWrapper_P18TPatternAnmControl_Fv@l
    addi    r3, r29, 0x58
    li      r5, 0x0
    li      r6, 0x8
    li      r7, 0x3
    ...
    lis     r5, unk_6f796132@h
    lwz     r4, 0x0(r29)
    addi    r3, r27, 0x0
    addi    r5, r5, unk_6f796132@l
...
branch_0x801859c0:
    ...
    lwz     r3, 0x0(r29)
    lis     r4, unk_6d655f31@h
    addi    r4, r4, unk_6d655f31@l
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
...
__ct__19TOptionSubtitleUnitFP9J2DScreen: # 0x801863e0
    ...
    lis     r5, unk_74787032@h
    lwz     r4, 0x0(r31)
    addi    r3, r28, 0x0
    addi    r5, r5, unk_74787032@l
    bl      __ct__7TExPaneFP9J2DScreenUl
branch_0x80186428:
    stw     r28, 0x4(r31)
    li      r3, 0x2c
    ...
    lwz     r3, 0x0(r31)
    lis     r4, unk_6d655f32@h
    addi    r4, r4, unk_6d655f32@l
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
...
branch_0x801864c8:
    ...
    li      r0, 0x2
    stb     r0, 0x8(r29)
    lis     r0, unk_43300010@h
    addi    r3, r0, unk_43300010@l
    lfs     f2, -0x44c4(r2)
    stfs    f2, 0x10(r29)
    lwz     r5, 0xc(r31)
    lfs     f0, -0x44c8(r2)
...
branch_0x80186fe4:
    lwz     r5, 0x4(r4)
    lis     r3, unk_636e7430@h
    lwz     r4, 0xc(r4)
    addi    r0, r3, unk_636e7430@l
    subf    r4, r5, r4
    srawi   r4, r4, 2
    addze   r4, r4
    slwi    r4, r4, 2
...
__ct__17TOptionRumbleUnitFP9J2DScreen: # 0x8018706c
    ...
    lis     r5, unk_6f796131@h
    lwz     r4, 0x0(r31)
    addi    r3, r28, 0x0
    addi    r5, r5, unk_6f796131@l
    bl      __ct__7TExPaneFP9J2DScreenUl
branch_0x801870bc:
    stw     r28, 0x4(r31)
    li      r3, 0x2c
    ...
    lwz     r3, 0x0(r31)
    lis     r4, unk_6d655f30@h
    addi    r4, r4, unk_6d655f30@l
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
...
branch_0x801871fc:
    stw     r28, 0x14(r31)
    lis     r3, cRumbleAnm__9_unnamed_@ha
    addi    r3, r3, cRumbleAnm__9_unnamed_@l
    lwz     r28, 0x14(r31)
    li      r0, 0xa
    li      r30, 0x0
    stw     r3, 0x18(r28)
...
__sinit_Option_cpp: # 0x801877c8
    mflr    r0
    lis     r3, unk_803f7740@h
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803f7740@l
