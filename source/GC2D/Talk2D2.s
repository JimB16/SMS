...
__dt__8TTalk2D2Fv: # 0x801504a0
    ...
    lis     r3, __vvt__8TTalk2D2@h
    addi    r0, r3, __vvt__8TTalk2D2@l
    stw     r0, 0x0(r30)
...
branch_0x801506f0:
    ...
    li      r4, 0x0
    bl      load__10JUTTextureF11_GXTexMapID
    lis     r31, unk_0000ff00@ha
    addi    r0, r31, unk_0000ff00@l
    stw     r0, 0x68(sp)
    addi    r4, sp, 0x6c
    li      r3, 0x1
    lwz     r0, 0x68(sp)
...
setTagParam__8TTalk2D2FR20JSUMemoryInputStreamR10J2DTextBoxPiPi: # 0x801509e8
    ...
    stmw    r22, 0x108(sp)
    addi    r25, r4, 0x0
    lis     r4, unk_80387a18@h
    addi    r31, r3, 0x0
    addi    r24, r4, unk_80387a18@l
    addi    r30, r6, 0x0
    addi    r29, r7, 0x0
    addi    r3, r25, 0x0
    addi    r4, sp, 0xcd
...
branch_0x80150c44:
    ...
    lis     r4, unk_00020003@h
    lwz     r3, R13Off_m0x6060(r13)
    addi    r4, r4, unk_00020003@l
...
branch_0x80150c64:
    ...
    lis     r4, unk_00020002@h
    lwz     r3, R13Off_m0x6060(r13)
    addi    r4, r4, unk_00020002@l
    bl      getFlag__12TFlagManagerCFUl
    mr      r26, r3
    b       branch_0x80150ca0
...
branch_0x80150c84:
    ...
    lis     r4, unk_00020014@h
    lwz     r3, R13Off_m0x6060(r13)
    addi    r4, r4, unk_00020014@l
    bl      getFlag__12TFlagManagerCFUl
    mr      r26, r3
branch_0x80150ca0:
...
branch_0x80150cc0:
    ...
    mulli   r4, r4, 0x64
    subf    r5, r4, r26
    lis     r4, unk_057619f1@h
    subf    r5, r5, r26
    addi    r4, r4, unk_057619f1@l
    mulhw   r4, r4, r5
    srawi   r4, r4, 7
    srwi    r5, r4, 31
    add     r4, r4, r5
...
branch_0x801510cc:
    lis     r4, unk_00020004@h
    lwz     r3, R13Off_m0x6060(r13)
    addi    r4, r4, unk_00020004@l
    bl      getFlag__12TFlagManagerCFUl
    addi    r0, r3, 0x63
    lfd     f1, -0x4bc8(r2)
    xoris   r0, r0, 0x8000
...
branch_0x80151544:
    ...
    bl      read__14JSUInputStreamFPvl
    lbz     r4, 0xac(sp)
    lis     r3, cColorTable__8TTalk2D2@h
    addi    r0, r3, cColorTable__8TTalk2D2@l
    slwi    r3, r4, 2
    add     r3, r0, r3
    lwz     r0, 0x0(r3)
    stw     r0, 0x27c(r31)
...
branch_0x801515dc:
    ...
    addi    r0, sp, 0x78
    lwz     r9, 0x278(r30)
    lis     r8, __vvt__10JSUIosBase@ha
    li      r29, 0x0
    stw     r0, 0x48(sp)
    addi    r0, r8, __vvt__10JSUIosBase@l
    add     r8, r10, r9
    lwz     r3, 0x48(sp)
    lis     r7, __vvt__14JSUInputStream@h
    lis     r6, __vvt__20JSURandomInputStream@h
    stw     r0, 0x0(r3)
    add     r8, r4, r8
    addi    r0, r7, __vvt__14JSUInputStream@l
    stb     r29, 0x4(r3)
    addi    r4, r6, __vvt__20JSURandomInputStream@l
...
branch_0x801518c4:
    ...
    lwz     r3, 0x208(r30)
    bl      getStringPtr__10J2DTextBoxCFv
    lis     r4, unk_80387db4@h
    lwz     r6, 0x218(r30)
    addi    r5, r4, unk_80387db4@l
    lwz     r7, 0x21c(r30)
    crxor   6, 6, 6
    li      r4, 0x5e
    bl      snprintf
...
branch_0x80151904:
    lwz     r3, 0x208(r30)
    bl      getStringPtr__10J2DTextBoxCFv
    lis     r4, unk_80387dd0@h
    lwz     r6, 0x218(r30)
    addi    r5, r4, unk_80387dd0@l
    lwz     r7, 0x21c(r30)
    crxor   6, 6, 6
    li      r4, 0x5e
    bl      snprintf
branch_0x80151928:
    ...
    addi    r4, r4, __vvt__20JSUMemoryInputStream@l
    add     r0, r5, r0
    stw     r0, 0x278(r30)
...
setupBoardTextBox__8TTalk2D2FPCvP12JMSMesgEntry: # 0x80151978
    ...
    lwz     r8, 0x278(r3)
    addi    r28, r5, __vvt__10JSUIosBase@l
    lis     r5, __vvt__20JSUMemoryInputStream@h
    stw     r0, 0x34(sp)
    addi    r0, r7, __vvt__14JSUInputStream@l
    add     r7, r9, r8
    ...
    stb     r29, 0x4(r3)
    stw     r0, 0x0(r3)
    addi    r0, r6, __vvt__20JSURandomInputStream@l
    stw     r0, 0x0(r3)
    addi    r0, r5, __vvt__20JSUMemoryInputStream@l
    li      r5, 0x400
    stw     r0, 0x0(r3)
...
branch_0x80151b9c:
    ...
    addi    r4, r4, __vvt__21JSUMemoryOutputStream@l
    add     r0, r5, r0
    stw     r0, 0x278(r30)
...
branch_0x80151cc0:
    ...
    lis     r3, unk_803c03ec@h
    addi    r3, r3, unk_803c03ec@l
    slwi    r0, r0, 2
    lwzx    r0, r3, r0
    mtctr   r0
    bctr       
...
branch_0x80151d44:
    ...
    mr      r3, r28
    bl      openBoardWindow__8TTalk2D2Fv
    b       branch_0x80151d64

branch_0x80151d5c:
    mr      r3, r28
    bl      openNormalWindow__8TTalk2D2Fv
branch_0x80151d64:
    clrlwi. r0, r3, 24
    beq-    branch_0x80151e94
    li      r0, 0x5
...
branch_0x80151d78:
    ...
    mr      r3, r28
    bl      moveBoardWindow__8TTalk2D2Fv
    mr      r3, r28
    bl      checkBoardControler__8TTalk2D2Fv
    b       branch_0x80151e94

branch_0x80151d98:
    mr      r3, r28
    bl      moveTalkWindow__8TTalk2D2Fv
    mr      r3, r28
    bl      checkControler__8TTalk2D2Fv
    b       branch_0x80151e94
...
branch_0x80151dd4:
    mr      r3, r28
    bl      closeNormalWindow__8TTalk2D2Fv
    mr      r31, r3
branch_0x80151de0:
    clrlwi. r0, r31, 24
    beq-    branch_0x80151e94
...
branch_0x80151e0c:
    ...
    mr      r3, r28
    bl      eraseBoardWindow__8TTalk2D2Fv
    b       branch_0x80151e2c

branch_0x80151e24:
    mr      r3, r28
    bl      eraseNormalWindow__8TTalk2D2Fv
branch_0x80151e2c:
    clrlwi. r0, r3, 24
    beq-    branch_0x80151e94
    lbz     r0, 0x28(r28)
...
branch_0x80152ca4:
    ...
    lwz     r3, 0x208(r31)
    bl      getStringPtr__10J2DTextBoxCFv
    lis     r4, unk_80387e04@h
    lwz     r6, 0x218(r31)
    addi    r5, r4, unk_80387e04@l
    lwz     r9, 0x21c(r31)
    crxor   6, 6, 6
    addi    r7, r30, 0x0
    addi    r8, r30, 0x0
...
branch_0x80152ce8:
    ...
    lwz     r3, 0x208(r31)
    bl      getStringPtr__10J2DTextBoxCFv
    lis     r4, unk_80387e44@h
    lwz     r8, 0x218(r31)
    addi    r5, r4, unk_80387e44@l
    lwz     r9, 0x21c(r31)
    crxor   6, 6, 6
    addi    r6, r30, 0x0
    addi    r7, r30, 0x0
...
branch_0x80153e20:
    ...
    lbz     r4, 0x8(r3)
    lis     r3, scTalkSoundList@h
    addi    r0, r3, scTalkSoundList@l
    slwi    r3, r4, 2
    add     r3, r0, r3
    lwz     r27, 0x0(r3)
    cmpwi   r27, -0x1
...
branch_0x801542d8:
    ...
    bl      setupTextBox__8TTalk2D2FPCvP12JMSMesgEntry
    lwz     r0, 0x25c(r28)
    lis     r4, unk_80387d24@h
    lis     r3, unk_80387d4c@h
    stw     r0, 0x260(r28)
    addi    r5, r4, unk_80387d24@l
    addi    r4, r3, unk_80387d4c@l
    lwz     r3, 0x0(r5)
    addi    r26, sp, 0x134
    lwz     r0, 0x4(r5)
    addi    r27, sp, 0x10c
...
load__8TTalk2D2FR20JSUMemoryInputStream: # 0x80154454
    mflr    r0
    lis     r5, unk_80387a18@h
    stw     r0, 0x4(sp)
    stwu    sp, -0x30(sp)
    stmw    r25, 0x14(sp)
    addi    r29, r3, 0x0
    addi    r31, r5, unk_80387a18@l
    bl      load__Q26JDrama8TNameRefFR20JSUMemoryInputStream
    addi    r3, r2, R2Off_m0x4b60
...
branch_0x801545fc:
    stw     r25, 0x244(r29)
    lis     r3, unk_6d655f30@h
    addi    r4, r3, unk_6d655f30@l
    lwz     r3, 0x2c(r29)
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
...
branch_0x80154660:
    ...
    bl      loadMessageData__14TMessageLoaderFPCc
    lwz     r3, 0x2c(r29)
    lis     r4, unk_6d655f34@h
    addi    r4, r4, unk_6d655f34@l
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
    stw     r3, 0x204(r29)
    lis     r3, unk_736c6374@h
    addi    r4, r3, unk_736c6374@l
    lwz     r3, 0x2c(r29)
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
...
branch_0x80154724:
    ...
    lis     r5, unk_6d625f30@h
    lwz     r4, 0x10(r29)
    addi    r3, r25, 0x0
    addi    r5, r5, unk_6d625f30@l
    bl      __ct__10TBoundPaneFP9J2DScreenUl
branch_0x8015474c:
    stw     r25, 0x14(r29)
    lis     r3, unk_74657874@h
    addi    r4, r3, unk_74657874@l
    lwz     r3, 0x10(r29)
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    ...
    bl      setFont__10J2DTextBoxFP7JUTFont
    lwz     r3, 0x10(r29)
    lis     r4, unk_63755f31@h
    addi    r4, r4, unk_63755f31@l
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
    stw     r3, 0x1c(r29)
    lis     r3, unk_63635f31@h
    addi    r4, r3, unk_63635f31@l
    lwz     r3, 0x10(r29)
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
    stw     r3, 0x20(r29)
    lis     r3, unk_63735f31@h
    addi    r4, r3, unk_63735f31@l
    lwz     r3, 0x10(r29)
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
...
__sinit_Talk2D2_cpp: # 0x8015499c
    mflr    r0
    lis     r3, unk_803f3ea8@h
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803f3ea8@l
