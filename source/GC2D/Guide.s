...
__dt__6TGuideFv: # 0x8017915c
    ...
    lis     r3, __vvt__6TGuide@h
    addi    r0, r3, __vvt__6TGuide@l
    stw     r0, 0x0(r30)
...
perform__6TGuideFUlPQ26JDrama9TGraphics: # 0x801791d0
    ...
    addi    r30, r4, 0x0
    addi    r31, r5, 0x0
    lbz     r6, R13Off_m0x63a8(r13)
    cmplwi  r6, 0x0
    beq-    branch_0x80179350
    addi    r0, r6, -0x1
    stb     r0, R13Off_m0x63a8(r13)
    lbz     r0, R13Off_m0x63a8(r13)
    cmplwi  r0, 0x0
    bne-    branch_0x801798dc
    addi    r3, r2, R2Off_m0x46bc
    addi    r4, r13, R13Off_m0x6010
...
branch_0x801793ac:
    ...
    lis     r3, unk_803c106c@h
    addi    r3, r3, unk_803c106c@l
    slwi    r0, r0, 2
    lwzx    r0, r3, r0
    mtctr   r0
    bctr       
...
branch_0x801795bc:
    ...
    addi    r7, r28, 0x0
    li      r6, 0x0
    bl      setPaneSize__7TExPaneFlllll
    lwz     r4, 0x8(r27)
    lis     r30, 0x4330
    lwz     r0, 0x10(r27)
    mr      r3, r27
...
branch_0x8017a3c4:
    ...
    lwz     r3, 0xbc(r30)
    lis     r4, unk_73625f69@h
    addi    r4, r4, unk_73625f69@l
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
    li      r29, 0x0
    stb     r29, 0xc(r3)
    lis     r3, unk_73635f74@h
    addi    r4, r3, unk_73635f74@l
    lwz     r3, 0xbc(r30)
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
...
branch_0x8017a61c:
    ...
    li      r28, 0x0
    stb     r28, 0xc(r3)
    lis     r3, unk_73715f69@h
    addi    r4, r3, unk_73715f69@l
    lwz     r3, 0xbc(r30)
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
...
branch_0x8017a998:
    lwz     r4, 0x0(r4)
    lis     r3, unk_6c16c16d@ha
    stb     r0, 0xcc(r4)
    addi    r0, r3, unk_6c16c16d@l
    lhz     r5, 0xf0(r29)
    lwz     r4, 0x128(r29)
    mulhwu  r3, r0, r5
    lwz     r31, 0x0(r4)
...
branch_0x8017b210:
    ...
    lis     r3, unk_f2b9d649@ha
    lhz     r5, 0xf0(r29)
    addi    r4, r3, unk_f2b9d649@l
    lwz     r3, 0x478(r29)
    mulhwu  r0, r4, r5
    srwi    r0, r0, 8
    mulli   r0, r0, 0x10e
...
branch_0x8017b654:
    ...
    lwz     r3, 0xbc(r31)
    lis     r4, unk_6c717573@h
    addi    r4, r4, unk_6c717573@l
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
...
branch_0x8017b6bc:
    ...
    lis     r3, unk_66666667@h
    addi    r30, r4, unk_51eb851f@l
    addi    r21, r3, unk_66666667@l
    li      r26, 0x1
    li      r23, 0x8
    li      r22, 0x4
branch_0x8017b6d8:
...
branch_0x8017b8f0:
    ...
    lwz     r3, 0xbc(r31)
    lis     r4, unk_6d693030@h
    addi    r4, r4, unk_6d693030@l
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
    stw     r3, 0x3d0(r31)
    lis     r3, unk_636c6963@h
    addi    r4, r3, unk_636c6963@l
    lwz     r3, 0xbc(r31)
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
    stw     r3, 0x448(r31)
    lis     r3, unk_00010056@h
    addi    r4, r3, unk_00010056@l
    lwz     r3, R13Off_m0x6060(r13)
    li      r19, 0x0
    bl      getBool__12TFlagManagerCFUl
    clrlwi. r0, r3, 24
...
branch_0x8017b980:
    ...
    add     r4, r31, r0
    lwz     r5, 0xc8(r4)
    lis     r4, unk_30735f31@h
    lwz     r12, 0x24(r12)
    lwz     r18, 0x20(r5)
    addi    r4, r4, unk_30735f31@l
    mtlr    r12
    blrl
    addi    r4, r18, 0x0
    li      r5, 0x0
...
branch_0x8017b9e8:
    ...
    add     r4, r31, r0
    lwz     r5, 0xc8(r4)
    lis     r20, unk_31735f31@h
    addi    r4, r20, unk_31735f31@l
    lwz     r22, 0x20(r5)
    blrl
    addi    r4, r22, 0x0
    li      r5, 0x0
...
branch_0x8017ba90:
    lwz     r3, 0xbc(r31)
    lis     r21, unk_6c745f31@h
    addi    r4, r21, unk_6c745f31@l
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
...
branch_0x8017bc44:
    lwz     r3, 0xbc(r31)
    lis     r19, unk_6c645f61@h
    addi    r4, r19, unk_6c645f61@l
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
...
resetObjects__6TGuideFv: # 0x8017bdf8
    mflr    r0
    lis     r4, scNormalStageTable_803c1020@h
    stw     r0, 0x4(sp)
    stwu    sp, -0x60(sp)
    stmw    r22, 0x38(sp)
    addi    r27, r3, 0x0
    addi    r25, r4, scNormalStageTable_803c1020@l
    li      r28, 0x0
    li      r31, 0x0
    li      r29, 0x0
    li      r26, 0x0
...
branch_0x8017c07c:
    ...
    li      r0, 0x1
    lis     r3, scNormalStageTable_803c1020@h
    stb     r0, 0x5c(r27)
    addi    r24, r3, scNormalStageTable_803c1020@l
    li      r22, 0x0
    li      r23, 0x0
    b       branch_0x8017c0d0
...
load__6TGuideFR20JSUMemoryInputStream: # 0x8017c180
    mflr    r0
    lis     r5, unk_80388798@ha
    stw     r0, 0x4(sp)
    li      r0, 0x0
    stwu    sp, -0x190(sp)
    stmw    r23, 0x16c(sp)
    addi    r31, r3, 0x0
    addi    r30, r5, unk_80388798@l
    stb     r0, 0xc5(r3)
...
branch_0x8017c1f8:
    stw     r25, 0xbc(r31)
    lis     r24, unk_615f6963@h
    addi    r4, r24, unk_615f6963@l
    lwz     r3, 0xbc(r31)
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    ...
    bl      setFont__10J2DTextBoxFP7JUTFont
    lwz     r3, 0xbc(r31)
    lis     r24, unk_625f6963@h
    addi    r4, r24, unk_625f6963@l
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
    ...
    li      r25, 0x0
    stw     r25, 0x124(r31)
    lis     r3, unk_735f6d6e@h
    addi    r4, r3, unk_735f6d6e@l
    lwz     r3, 0xbc(r31)
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
...
branch_0x8017c310:
    ...
    lwz     r3, 0xbc(r31)
    lis     r4, unk_73735f69@h
    addi    r4, r4, unk_73735f69@l
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
...
branch_0x8017c350:
    ...
    lwz     r3, 0xbc(r31)
    lis     r4, unk_73715f69@h
    addi    r4, r4, unk_73715f69@l
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
...
branch_0x8017c3e8:
    ...
    lwz     r3, 0xbc(r31)
    lis     r4, unk_73635f73@h
    addi    r4, r4, unk_73635f73@l
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
...
branch_0x8017c5e8:
    ...
    lis     r5, unk_6c77696e@h
    lwz     r4, 0xbc(r31)
    addi    r3, r23, 0x0
    addi    r5, r5, unk_6c77696e@l
    bl      __ct__7TExPaneFP9J2DScreenUl
branch_0x8017c684:
    stw     r23, 0x1f4(r31)
    li      r3, 0x54
    ...
    lis     r5, unk_6c6c696e@h
    lwz     r4, 0xbc(r31)
    addi    r3, r23, 0x0
    addi    r5, r5, unk_6c6c696e@l
    bl      __ct__7TExPaneFP9J2DScreenUl
branch_0x8017c6d4:
    stw     r23, 0x3ac(r31)
    li      r24, 0x0
...
branch_0x8017c6e0:
    ...
    lwz     r3, 0xbc(r31)
    lis     r24, unk_30316d69@h
    addi    r4, r24, unk_30316d69@l
    lwz     r12, 0x0(r3)
    lwz     r12, 0x24(r12)
    mtlr    r12
    blrl
...
branch_0x8017ca28:
    ...
    lis     r5, unk_6d61726b@h
    lwz     r4, 0xbc(r31)
    addi    r3, r23, 0x0
    addi    r5, r5, unk_6d61726b@l
    bl      __ct__7TExPaneFP9J2DScreenUl
branch_0x8017cb38:
    stw     r23, 0x478(r31)
    li      r3, 0x68
...
branch_0x8017cc7c:
    ...
    lis     r5, scEtcShineConvTable_803c0ff8@h
    slwi    r3, r3, 2
    addi    r0, r5, scEtcShineConvTable_803c0ff8@l
    add     r3, r0, r3
    lwz     r3, 0x0(r3)
    b       branch_0x8017ccb0

branch_0x8017cc9c:
    lis     r5, scShineConvTable_803c0fd0@h
    slwi    r3, r3, 2
    addi    r0, r5, scShineConvTable_803c0fd0@l
    add     r3, r0, r3
    lwz     r3, 0x0(r3)
branch_0x8017ccb0:
    cmplwi  r3, 0x0
...
__sinit_Guide_cpp: # 0x8017ccc8
    mflr    r0
    lis     r3, unk_803f4308@h
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803f4308@l
