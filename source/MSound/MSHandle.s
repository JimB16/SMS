...
branch_0x8001c8e8:
    ...
    lis     r3, unk_803aca20@ha
    addi    r3, r3, unk_803aca20@l
    slwi    r0, r0, 2
    lwzx    r0, r3, r0
    mtctr   r0
    bctr       
...
branch_0x8001c974:
    ...
    addi    r3, r3, smSeCategory__8MSHandle@l
    clrlslwi  r0, r4, 24, 4
    add     r3, r3, r0
    lfs     f3, 0xc(r3)
branch_0x8001c988:
...
branch_0x8001caec:
    lwz     r12, 0x40(r30)
    lis     r5, smSeCategory__8MSHandle@ha
    addi    r5, r5, smSeCategory__8MSHandle@l
    slwi    r0, r0, 4
    lwz     r12, 0x2c(r12)
    add     r5, r5, r0
    mtlr    r12
...
branch_0x8001ce04:
    li      r0, -0x1
branch_0x8001ce08:
    lis     r4, smSeCategory__8MSHandle@ha
    addi    r4, r4, smSeCategory__8MSHandle@l
    slwi    r0, r0, 4
    add     r4, r4, r0
    lfs     f2, 0x4(r4)
...
MSACos__8MSHandleFf: # 0x8001d0b0
    stwu    sp, -0x18(sp)
    lis     r3, unk_803ac730@ha
    addi    r3, r3, unk_803ac730@l
    lfs     f0, -0x7a60(r2)
    lfs     f2, -0x7a20(r2)
    fadds   f0, f0, f1
    fmuls   f0, f2, f0
...
__sinit_MSHandle_cpp: # 0x8001d10c
    mflr    r0
    lis     r3, unk_803eac70@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803eac70@l
