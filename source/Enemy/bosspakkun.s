...
.incbin "./baserom/code/Text_0x80005600.bin", 0x8ee58, 0x8009445c - 0x80094458
branch_0x8009445c:
    fsubs   f1, f1, f0
branch_0x80094460:
    fcmpo   cr0, f1, f3
...
.incbin "./baserom/code/Text_0x80005600.bin", 0x8ee88, 0x8009448c - 0x80094488
...
.incbin "./baserom/code/Text_0x80005600.bin", 0x90b3c, 0x80096140 - 0x8009613c
branch_0x80096140:
    lfs     f0, -0x66c4(rtoc)
    fmuls   f1, f1, f0
    b       branch_0x80096154
...
checkMarioRiding__11TBossPakkunFv: # 0x80096184
    ...
    rlwinm. r0, r3, 0, 22, 22 # MARIOSTATUS_200
    beq-    branch_0x80096214
    rlwinm. r0, r3, 0, 10, 10 # MARIOSTATUS_200000
    bne-    branch_0x80096214
    li      r0, 0x1
    stb     r0, 0x190(r31)
    li      r3, 0x1
...
.globl _32___dt__10TBPPolDropFv
_32___dt__10TBPPolDropFv: # 0x800996a8
    subi    r3, r3, 0x20
    b       __dt__10TBPPolDropFv


.globl _32___dt__10TBPTornadoFv
_32___dt__10TBPTornadoFv: # 0x800996b0
    subi    r3, r3, 0x20
    b       __dt__10TBPTornadoFv


.globl _32___dt__10TBPHeadHitFv
_32___dt__10TBPHeadHitFv: # 0x800996b8
    subi    r3, r3, 0x20
    b       __dt__10TBPHeadHitFv


.globl _32___dt__8TBPNavelFv
_32___dt__8TBPNavelFv: # 0x800996c0
    subi    r3, r3, 0x20
    b       __dt__8TBPNavelFv


.globl _104_4_calc__18TBossPakkunMtxCalcFUs
_104_4_calc__18TBossPakkunMtxCalcFUs: # 0x800996c8
    li      r11, 0x4
    lwzx    r11, r3, r11
    add     r3, r3, r11
    subi    r3, r3, 0x68
...
.globl _32___dt__11TBossPakkunFv
_32___dt__11TBossPakkunFv: # 0x800996dc
    subi    r3, r3, 0x20
