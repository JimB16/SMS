...
__dt__11TEnemyMarioFv: # 0x8003f738
    ...
    stw     r31, 0x14(sp)
    mr.     r31, r3
    lis     r3, unk_803ae858@ha
    stw     r30, 0x10(sp)
    addi    r30, r4, 0x0
    addi    r4, r3, unk_803ae858@l
    ...
    lis     r3, __vvt__6TMario@ha
    addi    r3, r3, __vvt__6TMario@l
    stw     r3, 0x0(r31)
    addi    r0, r3, 0x24
    addi    r3, r3, 0xb4
    stw     r0, 0x20(r31)
...
hitWater__11TEnemyMarioFP9THitActor: # 0x80040888
    ...
    lis     r3, unk_803af010@ha
    addi    r3, r3, unk_803af010@l
    slwi    r0, r0, 2
    lwzx    r0, r3, r0
    mtctr   r0
    bctr       
...
consider__11TEnemyMarioFv: # 0x80040a3c
    ...
    lis     r3, unk_803af04c@ha
    addi    r3, r3, unk_803af04c@l
    slwi    r0, r0, 2
    lwzx    r0, r3, r0
    mtctr   r0
    bctr       
...
branch_0x80040c10:
    mr      r3, r31
    bl      emWalkAround__11TEnemyMarioFv
    b       branch_0x80041278

branch_0x80040c1c:
    lwz     r30, 0x42a0(r31)
    addi    r3, r30, 0x104
    bl      getPoint__9TPathNodeCFv
    lwz     r5, 0x0(r3)
    addi    r4, r30, 0x10
    lwz     r0, 0x4(r3)
    stw     r5, 0xec(sp)
...
branch_0x80040cac:
    ...
    mulli   r0, r0, 0x64
    subf.   r0, r0, r3
    bne-    branch_0x80041278
    lis     r4, unk_80377844@h
    lwz     r3, R13Off_m0x70b0(r13)
    addi    r5, r4, unk_80377844@l
    addi    r4, r31, 0x10
    li      r6, 0x1
    li      r7, 0x0
...
branch_0x80040f4c:
    mr      r3, r31
    bl      emDisappearToGate__11TEnemyMarioFv
    b       branch_0x80041278
...
branch_0x80041040:
    mr      r3, r31
    bl      emReplayJumpToNearestNode__11TEnemyMarioFv
    b       branch_0x80041278
...
branch_0x8004109c:
    mr      r3, r31
    bl      emDownAnimation__11TEnemyMarioFv
    b       branch_0x80041278

branch_0x800410a8:
    mr      r3, r31
    bl      emRunAwayToNearestNode__11TEnemyMarioFv
    b       branch_0x80041278
...
branch_0x80041104:
    mr      r3, r31
    bl      tryTake__11TEnemyMarioFv
    clrlwi. r0, r3, 24
    beq-    branch_0x80041278
    lwz     r3, 0x42f0(r31)
    cmplwi  r3, 0x0
    ...
    lis     r4, unk_8037785c@h
    addi    r4, r4, unk_8037785c@l
...
branch_0x80041150:
    mr      r3, r31
    bl      decideDoingAfterCarry__11TEnemyMarioFv
    b       branch_0x80041278
...
branch_0x80041180:
    mr      r3, r31
    bl      emWaitingToInviteMario__11TEnemyMarioFv
    b       branch_0x80041278
...
branch_0x80041204:
    ...
    sth     r0, 0x1f8(sp)
    addi    r4, sp, 0xfc
    bl      checkController__6TMarioFPQ26JDrama9TGraphics
branch_0x80041278:
    lwz     r0, 0x224(sp)
    lwz     r31, 0x21c(sp)
    lwz     r30, 0x218(sp)
...
emWaitingToInviteMario__11TEnemyMarioFv: # 0x80041320
    ...
    bl      IConverge__Fiiii
    lha     r0, 0x4296(r31)
    lis     r30, unk_0c400201@h
    addi    r4, r30, unk_0c400201@l
    subf    r0, r3, r0
    sth     r0, 0x96(r31)
    addi    r3, r31, 0x0
    li      r5, 0x0
...
initEnemyValues__11TEnemyMarioFv: # 0x80043198
    mflr    r0
    lis     r5, unk_80377068@h
    stw     r0, 0x4(sp)
    li      r0, 0x2
    lis     r4, unk_803ae858@ha
    stwu    sp, -0x590(sp)
    stmw    r18, 0x558(sp)
    li      r19, 0x0
    addi    r31, r3, 0x0
    addi    r29, r5, unk_80377068@l
    addi    r26, r4, unk_803ae858@l
    li      r18, 0x6
    li      r20, 0x0
    sth     r0, 0x4290(r3)
    li      r0, 0x1a
...
branch_0x80043384:
    ...
    stw     r3, 0x42f0(r31)
    addi    r3, r4, gParticleFlagLoaded@l
    addi    r19, r3, 0xed
    lbz     r0, 0xed(r3)
    cmplwi  r0, 0x0
...
branch_0x8004342c:
    lfs     f0, -0x710c(r2)
    lis     r3, unk_00060003@h
    addi    r4, r3, unk_00060003@l
    stfs    f0, 0x42e8(r31)
    stfs    f0, 0x42e4(r31)
    stfs    f0, 0x42e0(r31)
...
branch_0x800434b4:
    ...
    addi    r24, r3, __vvt__10TParamT_f_@l
    stw     r24, 0x8(r30)
    lis     r3, __vvt__11TParamRT_f_@ha
    addi    r23, r3, __vvt__11TParamRT_f_@l
    lfs     f0, -0x70b0(r2)
    addi    r3, r29, 0x934
    stfs    f0, 0x18(r30)
    stw     r23, 0x8(r30)
    ...
    addi    r22, r3, __vvt__10TParamT_s_@l
    stw     r22, 0x30(r30)
    li      r0, 0x40
    lis     r3, __vvt__11TParamRT_s_@ha
    sth     r0, 0x40(r30)
    addi    r21, r3, __vvt__11TParamRT_s_@l
    addi    r3, r29, 0x950
    stw     r21, 0x30(r30)
    bl      calcKeyCode__Q26JDrama8TNameRefFPCc
    addi    r5, r3, 0x0
    ...
    stb     r19, 0x54(r30)
    addi    r27, r3, __vvt__12TParamRT_Uc_@l
    addi    r3, r29, 0x95c
    stw     r27, 0x44(r30)
    bl      calcKeyCode__Q26JDrama8TNameRefFPCc
    addi    r5, r3, 0x0
...
branch_0x80043718:
    ...
    bl      __ct__10TBaseParamFP7TParamsUsPCc
    lis     r3, __vvt__10TParamT_f_@ha
    addi    r23, r3, __vvt__10TParamT_f_@l
    stw     r23, 0x8(r30)
    lis     r3, __vvt__11TParamRT_f_@ha
    addi    r22, r3, __vvt__11TParamRT_f_@l
    lfs     f0, -0x70b0(r2)
    addi    r3, r29, 0x934
    stfs    f0, 0x18(r30)
    stw     r22, 0x8(r30)
    ...
    bl      __ct__10TBaseParamFP7TParamsUsPCc
    lis     r3, __vvt__10TParamT_s_@ha
    addi    r21, r3, __vvt__10TParamT_s_@l
    stw     r21, 0x30(r30)
    li      r0, 0x40
    lis     r3, __vvt__11TParamRT_s_@ha
    sth     r0, 0x40(r30)
    addi    r19, r3, __vvt__11TParamRT_s_@l
    addi    r3, r29, 0x950
    stw     r19, 0x30(r30)
    bl      calcKeyCode__Q26JDrama8TNameRefFPCc
    addi    r5, r3, 0x0
...
branch_0x80043c2c:
    ...
    addi    r5, r3, 0x0
    stw     r0, 0x0(r6)
    addi    r0, r4, __vvt__20JSUMemoryInputStream@l
    addi    r3, r6, 0x0
    stw     r0, 0x0(r6)
    mr      r4, r19
...
branch_0x80044274:
    lhz     r4, 0x114(r31)
    lis     r3, unk_0c400201@h
    addi    r0, r3, unk_0c400201@l
    ori     r3, r4, 0x2
    sth     r3, 0x114(r31)
    stw     r0, 0x7c(r31)
    stw     r0, 0x80(r31)
...
__dt__10JSUIosBaseFv: # 0x800443c0
    ...
    addi    r3, r3, __vvt__10JSUIosBase@l
    extsh.  r0, r4
    stw     r3, 0x0(r31)
...
initModel__11TEnemyMarioFv: # 0x8004440c
    ...
    addi    r31, r3, 0x0
    stw     r0, 0x394(r3)
    lis     r3, unk_80377068@h
    addi    r30, r3, unk_80377068@l
    stw     r0, 0x398(r31)
    stw     r0, 0x39c(r31)
    stw     r0, 0x3a0(r31)
    lwz     r26, R13Off_m0x60d8(r13)
    lwz     r3, 0x3a8(r26)
    lwz     r3, 0x8(r3)
    lwz     r0, 0x4(r3)
    stw     r0, 0x3ac(r31)
...
branch_0x80044578:
    ...
    stw     r22, 0x3bc(r31)
    bl      __nwa__FUl
    lis     r4, marioAnimeFiles@ha
    stw     r3, 0x4e0(r31)
    addi    r21, r4, marioAnimeFiles@l
    li      r19, 0x0
    li      r20, 0x0
branch_0x800445a8:
    add     r3, r21, r22
    ...
    addi    r28, r3, 0x0
    addi    r23, r6, marioAnimeTexPatternFilenames@l
    addi    r24, r5, __ct__11J3DTexNoAnmFv@l
    addi    r25, r4, __dt__11J3DTexNoAnmFv@l
    li      r21, 0x0
    li      r20, 0x0
branch_0x80044624:
    add     r3, r23, r20
...
__ct__12J3DFrameCtrlFv: # 0x80044b1c
    ...
    stw     r0, 0x4(sp)
    addi    r0, r4, __vvt__12J3DFrameCtrl@l
    li      r4, 0x0
    stwu    sp, -0x18(sp)
    stw     r31, 0x14(sp)
    addi    r31, r3, 0x0
...
__dt__11J3DTexNoAnmFv: # 0x80044c3c
    ...
    lis     r3, __vvt__11J3DTexNoAnm@h
    addi    r3, r3, __vvt__11J3DTexNoAnm@l
    extsh.  r0, r4
    stw     r3, 0x0(r31)
...
__ct__11J3DTexNoAnmFv: # 0x80044c88
    lis     r4, __vvt__11J3DTexNoAnm@h
    addi    r0, r4, __vvt__11J3DTexNoAnm@l
    stw     r0, 0x0(r3)
    li      r0, 0x0
    stw     r0, 0x8(r3)
    sth     r0, 0x4(r3)
...
__sinit_enemyMario_cpp: # 0x80044fd4
    mflr    r0
    lis     r3, unk_803f01c8@h
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803f01c8@l
...
.globl unk_800452d0
unk_800452d0: # 0x800452d0
    addi    r3, r3, -0x20
    b       __dt__11TEnemyMarioFv


.globl unk_800452d8
unk_800452d8: # 0x800452d8
    addi    r3, r3, -0x70
