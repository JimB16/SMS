...
branch_0x8003ec98:
    ...
    lis     r3, unk_80376fd8@h
    addi    r29, r3, unk_80376fd8@l
    addi    r27, sp, 0x5c
    addi    r26, sp, 0x6c
    li      r25, 0x0
    b       branch_0x8003ed80
...
branch_0x8003ee98:
    ...
    addi    r3, r3, 0x8
    bl      __nwa__FUl
    lis     r4, __ct__16TSharedMActorSetFv@ha
    addi    r4, r4, __ct__16TSharedMActorSetFv@l
    addi    r7, r28, 0x0
    li      r5, 0x0
    li      r6, 0xc
...
__dt__13TEnemyManagerFv: # 0x8003ef60
    ...
    lis     r3, __vvt__13TEnemyManager@ha
    addi    r0, r3, __vvt__13TEnemyManager@l
    stw     r0, 0x0(r30)
...
__ct__17TSpineEnemyParamsFPCc: # 0x8003f258
    ...
    stw     r28, 0x10(sp)
    stw     r4, 0x0(r3)
    lis     r3, unk_80376ef8@h
    addi    r31, r3, unk_80376ef8@l
    stw     r0, 0x4(r30)
    addi    r3, r31, 0xec
    bl      calcKeyCode__Q26JDrama8TNameRefFPCc
    addi    r5, r3, 0x0
...
__sinit_enemymanager_cpp: # 0x8003f43c
    mflr    r0
    lis     r3, unk_803f0110@h
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803f0110@l
