...
__dt__14TEMarioManagerFv: # 0x80038fe0
    ...
    lis     r3, __vvt__14TEMarioManager@ha
    addi    r0, r3, __vvt__14TEMarioManager@l
    stw     r0, 0x0(r30)
    addi    r3, r30, 0x0
    li      r4, 0x0
...
createEnemyInstance__14TEMarioManagerFv: # 0x80039044
    ...
    lis     r4, unk_80376e4c@h
    addi    r3, r31, 0x0
    addi    r4, r4, unk_80376e4c@l
    bl      __ct__11TSpineEnemyFPCc
    lis     r3, __vvt__7TEMario@ha
    addi    r3, r3, __vvt__7TEMario@l
    stw     r3, 0x0(r31)
    addi    r0, r3, 0x24
    stw     r0, 0x20(r31)
branch_0x80039088:
...
load__14TEMarioManagerFR20JSUMemoryInputStream: # 0x800390a0
    ...
    lis     r3, unk_80376e5c@h
    addi    r4, r3, unk_80376e5c@l
    addi    r3, r29, 0x0
...
branch_0x80039650:
    stw     r29, 0x78(r31)
    lis     r0, unk_11300000@h
    addi    r5, r0, unk_11300000@l
    lwz     r3, 0x78(r31)
    stw     r0, 0x14(r3)
    lwz     r4, 0xc(r30)
    lwz     r3, 0x78(r31)
...
branch_0x8003968c:
    ...
    lis     r4, unk_80376e70@h
    addi    r4, r4, unk_80376e70@l
...
branch_0x80039708:
    ...
    lwz     r4, 0x4(r3)
    lis     r3, unk_80376e84@h
    addi    r5, r3, unk_80376e84@l
    lwz     r3, R13Off_m0x6104(r13)
    lwz     r4, 0x4(r4)
...
load__7TEMarioFR20JSUMemoryInputStream: # 0x80039810
    mflr    r0
    lis     r5, unk_80376d28@h
    stw     r0, 0x4(sp)
    stwu    sp, -0xf0(sp)
    stw     r31, 0xec(sp)
    addi    r31, r5, unk_80376d28@l
    stw     r30, 0xe8(sp)
    addi    r30, r3, 0x0
    stw     r29, 0xe4(sp)
    addi    r29, r4, 0x0
...
branch_0x800398ec:
    ...
    mr      r3, r29
    bl      __ct__6TMarioFv
    lis     r3, __vvt__11TEnemyMario@ha
    addi    r4, r3, __vvt__11TEnemyMario@l
    stw     r4, 0x0(r29)
    addi    r3, r4, 0x24
    addi    r0, r4, 0xb4
    stw     r3, 0x20(r29)
...
__sinit_emario_cpp: # 0x80039c60
    mflr    r0
    lis     r3, unk_803effa0@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803effa0@l
