...
branch_0x800fd50c:
    ...
    lis     r3, sSnortStepFrames@h
    addi    r29, r3, sSnortStepFrames@l
    clrlwi  r28, r27, 24
    li      r25, 0x0
    li      r30, 0x0
branch_0x800fd52c:
...
staticLoadParticle__13TBossHanachanFv: # 0x800fdb60
    ...
    addi    r30, r3, 0x76
    lbz     r0, 0x76(r3)
    lis     r3, unk_80382d38@h
    addi    r31, r3, unk_80382d38@l
    cmplwi  r0, 0x0
...
__sinit_BossHanachanEffect_cpp: # 0x800fde94
    mflr    r0
    lis     r3, unk_803f2958@h
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803f2958@l
