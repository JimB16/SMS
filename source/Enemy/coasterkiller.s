...
__dt__21TCoasterKillerManagerFv: # 0x80133c0c
    ...
    lis     r3, __vvt__21TCoasterKillerManager@ha
    addi    r0, r3, __vvt__21TCoasterKillerManager@l
    stw     r0, 0x0(r30)
...
createEnemyInstance__21TCoasterKillerManagerFv: # 0x80133c80
    ...
    stw     r31, 0xc(sp)
    lis     r3, unk_80386b7c@h
    addi    r4, r3, unk_80386b7c@l
    stw     r31, 0x10(sp)
    lwz     r3, 0xc(sp)
    bl      __ct__12TWalkerEnemyFPCc
    lwz     r4, 0xc(sp)
    lis     r3, __vvt__13TCoasterEnemy@ha
    addi    r3, r3, __vvt__13TCoasterEnemy@l
    stw     r3, 0x0(r4)
    addi    r3, r3, 0x24
    li      r0, 0x0
    stw     r3, 0x20(r4)
    ...
    lwz     r4, 0x10(sp)
    lis     r3, __vvt__14TCoasterKiller@ha
    addi    r3, r3, __vvt__14TCoasterKiller@l
    stw     r3, 0x0(r4)
    addi    r0, r3, 0x24
    addi    r3, r4, 0x1d0
    stw     r0, 0x20(r4)
...
createModelData__21TCoasterKillerManagerFv: # 0x80133db4
    mflr    r0
    lis     r4, entry_2932@ha
    stw     r0, 0x4(sp)
    addi    r4, r4, entry_2932@l
    stwu    sp, -0x8(sp)
    lwz     r12, 0x0(r3)
    lwz     r12, 0x2c(r12)
    mtlr    r12
...
load__21TCoasterKillerManagerFR20JSUMemoryInputStream: # 0x80133e1c
    ...
    mr      r31, r3
    lwz     r0, 0x38(r3)
    lis     r3, unk_80386a20@h
    addi    r28, r3, unk_80386a20@l
    cmplwi  r0, 0x0
    mr      r3, r31
...
__dt__28TNerveCoasterKillerExplosionFv: # 0x80134104
    ...
    lis     r3, __vvt__28TNerveCoasterKillerExplosion@ha
    addi    r0, r3, __vvt__28TNerveCoasterKillerExplosion@l
    stw     r0, 0x0(r31)
...
setDeadAnm__14TCoasterKillerFv: # 0x80134160
    mflr    r0
    lis     r4, unk_80386b64@h
    stw     r0, 0x4(sp)
    addi    r4, r4, unk_80386b64@l
    stwu    sp, -0x18(sp)
    stw     r31, 0x14(sp)
    stw     r30, 0x10(sp)
    mr      r30, r3
    ...
    mtlr    r12
    blrl
    lis     r4, unk_80386bec@h
    lwz     r3, R13Off_m0x70b0(r13)
    addi    r5, r4, unk_80386bec@l
    addi    r4, r30, 0x10
    li      r6, 0x1
...
setNormalFlyAnm__14TCoasterKillerFv: # 0x80134214
    mflr    r0
    lis     r4, unk_80386b50@h
    stw     r0, 0x4(sp)
    addi    r4, r4, unk_80386b50@l
    stwu    sp, -0x18(sp)
    stw     r31, 0x14(sp)
    mr      r31, r3
    lwz     r3, 0x78(r3)
...
getBasNameTable__14TCoasterKillerCFv: # 0x80134268
    lis     r3, killer_bastable_803bed38@ha
    addi    r3, r3, killer_bastable_803bed38@l
    blr
...
behaveToWater__14TCoasterKillerFP9THitActor: # 0x80134274
    ...
    stw     r31, 0x34(sp)
    addi    r31, r3, 0x0
    lbz     r0, R13Off_m0x64d8(r13)
    extsb.  r0, r0
    bne-    branch_0x801342cc
    lis     r3, __vvt__24TNerveBase_10TLiveActor_@ha
    addi    r0, r3, __vvt__24TNerveBase_10TLiveActor_@l
    lis     r3, __vvt__28TNerveCoasterKillerExplosion@ha
    stw     r0, R13Off_m0x64d4(r13)
    addi    r0, r3, __vvt__28TNerveCoasterKillerExplosion@l
    lis     r4, __dt__28TNerveCoasterKillerExplosionFv@h
    stw     r0, R13Off_m0x64d4(r13)
    lis     r3, unk_803f388c@h
    addi    r5, r3, unk_803f388c@l
    addi    r4, r4, __dt__28TNerveCoasterKillerExplosionFv@l
    addi    r3, r13, R13Off_m0x64d4
    bl      __register_global_object
    li      r0, 0x1
    stb     r0, R13Off_m0x64d8(r13)
branch_0x801342cc:
    lwz     r4, 0x8c(r31)
    addi    r3, r13, R13Off_m0x64d4
    lwz     r0, 0x14(r4)
    ...
    lis     r4, __vvt__28TNerveCoasterKillerExplosion@ha
    stw     r0, R13Off_m0x64d4(r13)
    addi    r0, r4, __vvt__28TNerveCoasterKillerExplosion@l
    lis     r4, __dt__28TNerveCoasterKillerExplosionFv@h
    stw     r0, R13Off_m0x64d4(r13)
    lis     r5, unk_803f388c@h
    addi    r4, r4, __dt__28TNerveCoasterKillerExplosionFv@l
    addi    r5, r5, unk_803f388c@l
    bl      __register_global_object
    li      r0, 0x1
    stb     r0, R13Off_m0x64d8(r13)
branch_0x80134320:
    addi    r6, r13, R13Off_m0x64d4
    lwz     r5, 0x8c(r31)
    cmplwi  r6, 0x0
    beq-    branch_0x80134378
    lwz     r0, 0x14(r5)
...
isCollidMove__14TCoasterKillerFP9THitActor: # 0x8013438c
    mflr    r0
    lis     r5, unk_803f3880@h
    stw     r0, 0x4(sp)
    stwu    sp, -0x48(sp)
    stw     r31, 0x44(sp)
    addi    r31, r5, unk_803f3880@l
    stw     r30, 0x40(sp)
    addi    r30, r4, 0x0
    stw     r29, 0x3c(sp)
    addi    r29, r3, 0x0
    ...
    stw     r0, R13Off_m0x64d4(r13)
    addi    r0, r3, __vvt__28TNerveCoasterKillerExplosion@l
    lis     r3, __dt__28TNerveCoasterKillerExplosionFv@h
    stw     r0, R13Off_m0x64d4(r13)
    addi    r4, r3, __dt__28TNerveCoasterKillerExplosionFv@l
    addi    r3, r13, R13Off_m0x64d4
    addi    r5, r31, 0xc
    bl      __register_global_object
    li      r0, 0x1
...
setMActorAndKeeper__14TCoasterKillerFv: # 0x801346ec
    mflr    r0
    lis     r4, unk_80386a20@h
    stw     r0, 0x4(sp)
    stwu    sp, -0xa0(sp)
    stmw    r27, 0x8c(sp)
    addi    r30, r3, 0x0
    addi    r31, r4, unk_80386a20@l
    li      r3, 0x18
    bl      __nw__FUl
    mr.     r27, r3
...
init__14TCoasterKillerFP12TLiveManager: # 0x801349f8
    ...
    lbz     r0, R13Off_m0x64e0(r13)
    extsb.  r0, r0
    bne-    branch_0x80134a78
    addi    r3, r13, R13Off_m0x64dc
    bl      __ct__24TNerveBase_10TLiveActor_Fv
    lis     r3, __vvt__24TNerveCoasterEnemyWander@ha
    addi    r0, r3, __vvt__24TNerveCoasterEnemyWander@l
    lis     r4, __dt__24TNerveCoasterEnemyWanderFv@h
    stw     r0, R13Off_m0x64dc(r13)
    lis     r3, unk_803f3880@h
    addi    r5, r3, unk_803f3880@l
    addi    r4, r4, __dt__24TNerveCoasterEnemyWanderFv@l
    addi    r3, r13, R13Off_m0x64dc
    bl      __register_global_object
    li      r0, 0x1
    stb     r0, R13Off_m0x64e0(r13)
branch_0x80134a78:
    lwz     r6, 0x8c(r31)
    li      r5, 0x0
    lis     r3, unk_0800001f@h
    stw     r5, 0x8(r6)
    addi    r4, r13, R13Off_m0x64dc
    addi    r3, r3, unk_0800001f@l
    stw     r5, 0x20(r6)
    li      r0, 0x11
    stw     r4, 0x14(r6)
    stw     r4, 0x18(r6)
...
__ct__14TCoasterKillerFPCc: # 0x80134b94
    ...
    stw     r0, 0x20(r31)
    li      r0, 0x0
    addi    r4, r3, __vvt__14TCoasterKiller@l
    stw     r0, 0x198(r31)
    addi    r0, r4, 0x24
    addi    r3, r31, 0x0
    stw     r4, 0x0(r31)
...
.globl unk_80135ad8
unk_80135ad8: # 0x80135ad8
    addi    r3, r3, -0x20
    b       __dt__13TCoasterEnemyFv


.globl unk_80135ae0
unk_80135ae0: # 0x80135ae0
    addi    r3, r3, -0x20
