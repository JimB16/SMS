...
__dt__22TCommonLauncherManagerFv: # 0x800a291c
    ...
    lis     r3, __vvt__22TCommonLauncherManager@h
    addi    r0, r3, __vvt__22TCommonLauncherManager@l
    stw     r0, 0x0(r30)
...
createModelData__22TCommonLauncherManagerFv: # 0x800a29b0
    mflr    r0
    lis     r4, entry_2906@ha
    stw     r0, 0x4(sp)
    addi    r4, r4, entry_2906@l
    stwu    sp, -0x8(sp)
    lwz     r12, 0x0(r3)
    lwz     r12, 0x2c(r12)
    mtlr    r12
...
getBasNameTable__15TCommonLauncherCFv: # 0x800a2bfc
    lis     r3, clauncher_bastable@h
    addi    r3, r3, clauncher_bastable@l
    blr
...
init__15TCommonLauncherFP12TLiveManager: # 0x800a317c
    ...
    stw     r28, 0xa0(sp)
    stw     r3, 0x8(sp)
    lis     r3, unk_8037d3d8@ha
    addi    r30, r3, unk_8037d3d8@l
    lwz     r29, 0x8(sp)
    stw     r4, 0x70(r29)
    mr      r4, r29
    lwz     r3, 0x70(r29)
...
branch_0x800a31d8:
    ...
    stw     r0, R13Off_m0x72bc(r13)
    lis     r3, unk_803f14b0@h
    addi    r5, r3, unk_803f14b0@l
...
__ct__15TCommonLauncherFPCc: # 0x800a3468
    ...
    stw     r3, 0x0(r31)
    addi    r0, r3, 0x24
    lis     r3, __vvt__15TCommonLauncher@h
    stw     r0, 0x20(r31)
    li      r0, 0x2
    addi    r5, r3, __vvt__15TCommonLauncher@l
    stw     r0, 0x150(r31)
    li      r6, 0x0
    addi    r4, r5, 0x24
    stw     r6, 0x154(r31)
...
load__16TLauncherManagerFR20JSUMemoryInputStream: # 0x800a3554
    mflr    r0
    lis     r5, unk_8037d3d8@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0x20(sp)
    stw     r31, 0x1c(sp)
    addi    r31, r5, unk_8037d3d8@l
    stw     r30, 0x18(sp)
    addi    r30, r4, 0x0
    stw     r29, 0x14(sp)
    addi    r29, r3, 0x0
...
branch_0x800a3b64:
    ...
    stw     r0, 0x15c(r31)
branch_0x800a3bf4:
    lis     r3, unk_10000014@h
    addi    r0, r3, unk_10000014@l
    stw     r0, 0x4c(r31)
    mr      r3, r31
    lwz     r0, 0x64(r31)
    oris    r0, r0, 0x100
...
__dt__15TCommonLauncherFv: # 0x800a3cb0
    ...
    lis     r3, __vvt__15TCommonLauncher@h
    addi    r3, r3, __vvt__15TCommonLauncher@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    stw     r0, 0x20(r30)
...
.globl unk_800a4030
unk_800a4030: # 0x800a4030
    addi    r3, r3, -0x20
    b       __dt__9TLauncherFv


.globl unk_800a4038
unk_800a4038: # 0x800a4038
    addi    r3, r3, -0x20
