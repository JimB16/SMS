...
__dt__22TBossHanachanPartsHeadFv: # 0x800f2f80
    ...
    lis     r3, __vvt__22TBossHanachanPartsHead@ha
    addi    r3, r3, __vvt__22TBossHanachanPartsHead@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    stw     r0, 0x20(r30)
    beq-    branch_0x800f2fd8
    lis     r3, __vvt__22TBossHanachanPartsBase@ha
    addi    r3, r3, __vvt__22TBossHanachanPartsBase@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    addi    r3, r30, 0x0
    stw     r0, 0x20(r30)
...
branch_0x800f3314:
    ...
    lis     r3, unk_803bb048@ha
    addi    r3, r3, unk_803bb048@l
    slwi    r0, r5, 2
    lwzx    r0, r3, r0
    mtctr   r0
    bctr       
...
setAnm___22TBossHanachanPartsHeadF23EnumBossHanachanAnmKind36EnumBossHanachanStopMotionBlendOnOff: # 0x800f33c0
    ...
    li      r31, 0x0
    lwz     r0, 0xf4(r3)
    lis     r3, unk_80381e08@h
    addi    r28, r3, unk_80381e08@l
    cmpw    r0, r30
...
setAnm___22TBossHanachanPartsBodyF23EnumBossHanachanAnmKind36EnumBossHanachanStopMotionBlendOnOff: # 0x800f34dc
    ...
    lwz     r3, 0x74(r29)
    bl      getCurAnmIdx__6MActorCFi
    lis     r4, sBodyBckIndex_2891@h
    slwi    r5, r30, 2
    addi    r0, r4, sBodyBckIndex_2891@l
    add     r4, r0, r5
    lwz     r0, 0x0(r4)
    cmpw    r0, r3
...
getSandActor___22TBossHanachanPartsBaseCFv: # 0x800f3df8
    ...
    stwu    sp, -0x18(sp)
    stw     r31, 0x14(sp)
    lis     r31, unk_400000cd@h
    addi    r4, r31, unk_400000cd@l
    stw     r30, 0x10(sp)
    addi    r30, r3, 0x0
    lwz     r3, 0xc4(r3)
...
initFootHitActor___22TBossHanachanPartsBodyFP12TIdxGroupObj: # 0x800f427c
    mflr    r0
    lis     r5, __vvt__14TWaterHitActor@ha
    stw     r0, 0x4(sp)
    stwu    sp, -0xf0(sp)
    stmw    r14, 0xa8(sp)
    addi    r29, r5, __vvt__14TWaterHitActor@l
    mr      r18, r3
    addi    r27, r29, 0x24
    addi    r28, r4, 0x10
    addi    r17, sp, 0x60
    ...
    lwz     r6, 0x74(r3)
    lwz     r7, 0xfc(r3)
    lis     r3, __vvt__13TFootHitActor@ha
    lwz     r6, 0x4(r6)
    addi    r30, r3, __vvt__13TFootHitActor@l
    lwz     r7, 0x1bc(r7)
    lwz     r5, 0x4(r6)
    lis     r3, unk_80382070@h
    addi    r26, r30, 0x24
    lwz     r19, 0xb0(r5)
    addi    r25, r7, 0x158
    addi    r24, r7, 0x144
    addi    r23, r7, 0x130
    addi    r22, r7, 0x11c
    addi    r14, r3, unk_80382070@l
branch_0x800f42e8:
    addi    r3, r13, R13Off_m0x7d5c
    lwzx    r4, r3, r31
    mr      r3, r19
...
initMapCollisionAndHitActor___22TBossHanachanPartsBaseFP12TIdxGroupObj: # 0x800f4420
    ...
    stw     r28, 0xb8(sp)
    lwz     r6, 0xfc(r3)
    lis     r3, unk_08000015@h
    lwz     r5, 0x4c(r29)
    addi    r0, r3, unk_08000015@l
    lwz     r6, 0x1bc(r6)
    cmpw    r5, r0
    lwz     r31, R13Off_m0x7d74(r13)
    lfs     f31, 0xb8(r6)
    lfs     f30, 0xcc(r6)
    lfs     f29, 0xe0(r6)
    lfs     f28, 0xf4(r6)
...
branch_0x800f4504:
    ...
    lis     r4, unk_80382084@h
    addi    r3, r28, 0x0
    addi    r4, r4, unk_80382084@l
    bl      __ct__9THitActorFPCc
...
__ct__22TBossHanachanPartsHeadFP13TBossHanachanPCc: # 0x800f4640
    mflr    r0
    lis     r6, unk_08000014@h
    stw     r0, 0x4(sp)
    addi    r7, r5, 0x0
    addi    r5, r6, unk_08000014@l
    stwu    sp, -0x50(sp)
    li      r6, 0x1
    stw     r31, 0x4c(sp)
    stw     r30, 0x48(sp)
...
__ct__22TBossHanachanPartsBodyFP13TBossHanachanPCc: # 0x800f476c
    mflr    r0
    lis     r6, unk_08000015@h
    stw     r0, 0x4(sp)
    addi    r7, r5, 0x0
    addi    r5, r6, unk_08000015@l
    stwu    sp, -0x50(sp)
    li      r6, 0x0
    stw     r31, 0x4c(sp)
    stw     r30, 0x48(sp)
    ...
    lwz     r3, 0x8(sp)
    bl      __ct__22TBossHanachanPartsBaseFP13TBossHanachanUliPCc
    lis     r3, __vvt__22TBossHanachanPartsBody@ha
    lwz     r30, 0x8(sp)
    addi    r3, r3, __vvt__22TBossHanachanPartsBody@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    addi    r3, r30, 0x0
    stw     r0, 0x20(r30)
...
__dt__13TFootHitActorFv: # 0x800f4a44
    ...
    lis     r3, __vvt__13TFootHitActor@ha
    addi    r3, r3, __vvt__13TFootHitActor@l
    stw     r3, 0x0(r30)
    addi    r0, r3, 0x24
    stw     r0, 0x20(r30)
...
__sinit_BossHanachanParts_cpp: # 0x800f4bc0
    mflr    r0
    lis     r3, unk_803f2680@h
    stw     r0, 0x4(sp)
    stwu    sp, -0x10(sp)
    stw     r31, 0xc(sp)
    addi    r31, r3, unk_803f2680@l
...
.globl unk_800f4ebc
unk_800f4ebc: # 0x800f4ebc
    addi    r3, r3, -0x20
    b       __dt__22TBossHanachanPartsBodyFv


.globl unk_800f4ec4
unk_800f4ec4: # 0x800f4ec4
    addi    r3, r3, -0x20
    b       __dt__13TFootHitActorFv


.globl unk_800f4ecc
unk_800f4ecc: # 0x800f4ecc
    addi    r3, r3, -0x20
